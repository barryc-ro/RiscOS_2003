...
/**************************************************************************/
#ifndef DEBUGLIB_SERIAL_LIB_H_INCLUDED
#define DEBUGLIB_SERIAL_LIB_H_INCLUDED

#if defined(ENABLE_SERIAL_SUPPORT) && defined(__riscos)
 ...
 *
 */
extern int debug_serial_lib_open_stream(char *filename, int rights);
 ...
 *
 */
extern void debug_serial_lib_close_stream(int handle);
 ...
 *
 */
extern unsigned int debug_serial_lib_ioctl(int handle, ioctl_t *ioctl_block);
 ...
 *
 */
extern int debug_serial_lib_read_stream(int handle, char *data_block, int size);
 ...
 *
 */
extern int debug_serial_lib_read_byte(int handle);
 ...
 *
 */
extern int debug_serial_lib_write_stream(int handle, char *data_block, int size);
 ...
 *
 */
extern int debug_serial_lib_write_byte(int handle, char data);
 ...
 *
 */
extern int debug_serial_lib_size(int handle);
 ...
 *
 */
extern void debug_serial_lib_write_str(int handle, char* string);
...
#endif /* defined(ENABLE_SERIAL_SUPPORT) && defined(__riscos) */

#endif /* DEBUGLIB_SERIAL_LIB_H_INCLUDED */
