...
MANCGI='http://intranet.cam.pace.co.uk/~renaissa/man.cgi'

# The URL of the two images :
DOT='http://intranet.cam.pace.co.uk/~renaissa/pics/bullet.gif'
PAGES='http://intranet.cam.pace.co.uk/~renaissa/pics/pages.gif'
...
cat <<END
  <hr>
  Generated by <a href="http://intranet.cam.pace.co.uk/~renaissa/man.cgi">man-cgi</a> $VERSION
  </body>
  </html>
END
