...
MANCGI='http://www.internal.acorn.co.uk/~renaissa/docs/man.cgi'

# The URL of the two images :
DOT='http://www.internal.acorn.co.uk/~renaissa/docs/pics/bullet.gif'
PAGES='http://www.internal.acorn.co.uk/~renaissa/docs/pics/pages.gif'
...
cat <<END
  <hr>
  Generated by <a href="http://dylan/cgi-bin/man-cgi">man-cgi</a> $VERSION
  </body>
  </html>
END
