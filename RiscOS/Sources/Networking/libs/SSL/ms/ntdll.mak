...
CC=cl
CFLAG=/W3 /WX /G5 /Ox /O2 /Ob2 /Gs0 /nologo -DWIN32 -DL_ENDIAN /MD
APP_CFLAG=
LIB_CFLAG=
APP_EX_OBJ=setargv.obj
SHLIB_EX_OBJ=
EX_LIBS=wsock32.lib user32.lib
...
HEADER=$(INCL_D)\e_os.h \
	...
	$(INCL_D)\progs.h $(INCL_D)\s_apps.h $(INCL_D)\s_eio.h \
	$(INCL_D)\testcert.h
...
$(OBJ_D)\s_filter.obj: $(SRC_D)\apps\s_filter.c
	$(CC) /Fo$(OBJ_D)\s_filter.obj -DMONOLITH $(APP_CFLAGS) -c $(SRC_D)\apps\s_filter.c
...
$(OBJ_D)\s_mult.obj: $(SRC_D)\apps\s_mult.c
	$(CC) /Fo$(OBJ_D)\s_mult.obj -DMONOLITH $(APP_CFLAGS) -c $(SRC_D)\apps\s_mult.c
...
$(O_SSL): $(SSLOBJ)
	$(LINK) $(MLFLAGS) /out:$(O_SSL) /def:ms/ssl32.def @<<
  $(SHLIB_EX_OBJ) $(SSLOBJ) $(L_CRYPTO) wsock32.lib
<<
...
$(O_CRYPTO): $(CRYPTOOBJ)
	$(LINK) $(MLFLAGS) /out:$(O_CRYPTO) /def:ms/crypto32.def @<<
  $(SHLIB_EX_OBJ) $(CRYPTOOBJ) wsock32.lib
<<
