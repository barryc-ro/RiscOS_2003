 ...
 *
 * The first two macros convert between the native sb8 type and the portable
...
/*
 * NCOS: gcc supports 64-bit integers natively, but libc doesn't.
 */
#define SYSB8_NATIVE
#ifdef LIBC_SUPPORTS_LONGLONG
# undef LIBC_SUPPORTS_LONGLONG
#endif

#ifdef SYSB8_NATIVE

typedef long long sysb8;
...
/*
 * The following uses of sb8 will be legal in some VS components
...
#ifdef lint
#define sb8lit(v)              ((sb8)0)
#else
#define sb8lit(v)              (v ## ll)
#endif
...
# undef SB8MAXVAL
#endif
#define SB8MAXVAL sb8lit(9223372036854775807)
