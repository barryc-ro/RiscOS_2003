...
/*
 * C++ extern "C" wrappers should be placed around all header files for
 * C code so that they can safely be included in C++ compilations.
 */
#ifdef __cplusplus
...
#else
#define externref extern __declspec(dllimport)
#endif
#endif
#ifndef externref
#define externref extern
 ...
 */
#define SYSX_OSDPTR_SIZE  ( 1280+128 )
