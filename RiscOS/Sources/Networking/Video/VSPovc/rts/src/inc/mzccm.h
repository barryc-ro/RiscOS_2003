/* GENERATED FILE
 * mzccm - public declarations
 * from /vobs/rts/src/inc/mzccm.idl
 */
...
/* interface mzc_chnlMgr declarations */
#ifndef mzc_chnlMgr_DECLARED
#define mzc_chnlMgr_DECLARED
typedef struct YCmzc_chnlMgr* mzc_chnlMgr;
yotk* mzc_chnlMgr__getTC(void);
#ifndef YCTC_mzc_chnlMgr
#define YCTC_mzc_chnlMgr   (mzc_chnlMgr__getTC())
#endif
#endif /* mzc_chnlMgr_DECLARED */

#ifndef mzc_chnlMgr_SUPP_FUNCS
#define mzc_chnlMgr_SUPP_FUNCS
void mzc_chnlMgr__free( mzc_chnlMgr* val, ysmff ffunc);
void mzc_chnlMgr__copy( mzc_chnlMgr* dest, mzc_chnlMgr* src, ysmaf afunc);
#endif /* mzc_chnlMgr_SUPP_FUNCS */

#ifndef YCIDL_sequence_mzc_chnlMgr_DEFINED
#define YCIDL_sequence_mzc_chnlMgr_DEFINED
typedef struct
{
  ub4 _maximum;
  ub4 _length;
  mzc_chnlMgr* _buffer;
} YCIDL_sequence_mzc_chnlMgr;
#ifndef YCIDL_sequence_mzc_chnlMgr_SUPP_FUNCS
#define YCIDL_sequence_mzc_chnlMgr_SUPP_FUNCS
#endif /* YCIDL_sequence_mzc_chnlMgr_SUPP_FUNCS */

#endif /* YCIDL_sequence_mzc_chnlMgr_DEFINED */
...
#ifndef mzc_chnlMgr_DEFINED
#define mzc_chnlMgr_DEFINED
struct yostub* mzc_chnlMgr__getStubs(void);
#define mzc_chnlMgr__stubs (mzc_chnlMgr__getStubs())
#endif /* mzc_chnlMgr_DEFINED */

CONST ysid* mzc_chnlMgr__getId(void);
#ifndef mzc_chnlMgr__id
#define mzc_chnlMgr__id   (mzc_chnlMgr__getId())
#endif
mzc_chnlreq mzc_chnlMgr_Authorize( mzc_chnlMgr or, yoenv* ev, mzc_chnlreq* 
  req);
void mzc_chnlMgr_Authorize_nw( mzc_chnlMgr or, yoenv* ev, mzc_chnlreq* req, 
  ysevt* _sem);
yopar* mzc_chnlMgr_Authorize__getPars(void);
#ifndef mzc_chnlMgr_Authorize_pars
#define mzc_chnlMgr_Authorize_pars (mzc_chnlMgr_Authorize__getPars())
#endif

#ifndef mzc_chnlMgr__tyimpl_DEFINED
#define mzc_chnlMgr__tyimpl_DEFINED
struct mzc_chnlMgr__tyimpl
{
  mzc_chnlreq (*Authorize)( mzc_chnlMgr, yoenv*, mzc_chnlreq*);
};
#endif /* mzc_chnlMgr__tyimpl_DEFINED */

#ifndef mzc_chnlMgrs_DECLARED
#define mzc_chnlMgrs_DECLARED
typedef YCIDL_sequence_mzc_chnlMgr mzc_chnlMgrs;
yotk* mzc_chnlMgrs__getTC(void);
#ifndef YCTC_mzc_chnlMgrs
#define YCTC_mzc_chnlMgrs   (mzc_chnlMgrs__getTC())
#endif
#endif /* mzc_chnlMgrs_DECLARED */

#ifndef mzc_chnlMgrs_SUPP_FUNCS
#define mzc_chnlMgrs_SUPP_FUNCS
void mzc_chnlMgrs__free( mzc_chnlMgrs* val, ysmff ffunc);
void mzc_chnlMgrs__copy( mzc_chnlMgrs* dest, mzc_chnlMgrs* src, ysmaf afunc)
  ;
#endif /* mzc_chnlMgrs_SUPP_FUNCS */

#ifndef mzc_channelManager_DECLARED
#define mzc_channelManager_DECLARED
typedef mzc_chnlMgr mzc_channelManager;
yotk* mzc_channelManager__getTC(void);
#ifndef YCTC_mzc_channelManager
#define YCTC_mzc_channelManager   (mzc_channelManager__getTC())
#endif
#endif /* mzc_channelManager_DECLARED */

#ifndef mzc_channelManager_SUPP_FUNCS
#define mzc_channelManager_SUPP_FUNCS
#define mzc_channelManager__free(val, ffunc) mzc_chnlMgr__free((val),(ffunc) \
  )
#define mzc_channelManager__copy(dest, src, afunc) mzc_chnlMgr__copy((dest), \
  (src),(afunc))
#endif /* mzc_channelManager_SUPP_FUNCS */

#ifndef mzc_channelManagers_DECLARED
#define mzc_channelManagers_DECLARED
typedef mzc_chnlMgrs mzc_channelManagers;
yotk* mzc_channelManagers__getTC(void);
#ifndef YCTC_mzc_channelManagers
#define YCTC_mzc_channelManagers   (mzc_channelManagers__getTC())
#endif
#endif /* mzc_channelManagers_DECLARED */

#ifndef mzc_channelManagers_SUPP_FUNCS
#define mzc_channelManagers_SUPP_FUNCS
#define mzc_channelManagers__free(val, ffunc) mzc_chnlMgrs__free((val),( \
  ffunc))
#define mzc_channelManagers__copy(dest, src, afunc) mzc_chnlMgrs__copy(( \
  dest),(src),(afunc))
#endif /* mzc_channelManagers_SUPP_FUNCS */
