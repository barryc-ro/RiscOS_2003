/* GENERATED FILE
 * mzup - public declarations
 * from /vobs/rts/src/inc/mzup.idl
 */
...
/* interface mzu_PPch declarations */
#ifndef mzu_PPch_DECLARED
#define mzu_PPch_DECLARED
typedef struct YCmzu_PPch* mzu_PPch;
yotk* mzu_PPch__getTC(void);
#ifndef YCTC_mzu_PPch
#define YCTC_mzu_PPch   (mzu_PPch__getTC())
#endif
#endif /* mzu_PPch_DECLARED */

#ifndef mzu_PPch_SUPP_FUNCS
#define mzu_PPch_SUPP_FUNCS
void mzu_PPch__free( mzu_PPch* val, ysmff ffunc);
void mzu_PPch__copy( mzu_PPch* dest, mzu_PPch* src, ysmaf afunc);
#endif /* mzu_PPch_SUPP_FUNCS */

#ifndef mzu_PPch_DEFINED
#define mzu_PPch_DEFINED
struct yostub* mzu_PPch__getStubs(void);
#define mzu_PPch__stubs (mzu_PPch__getStubs())
#endif /* mzu_PPch_DEFINED */

CONST ysid* mzu_PPch__getId(void);
#ifndef mzu_PPch__id
#define mzu_PPch__id   (mzu_PPch__getId())
#endif
mzc_chnlInfo mzc_chnl_GetInfo( mzc_chnl or, yoenv* ev);
void mzc_chnl_GetInfo_nw( mzc_chnl or, yoenv* ev, ysevt* _sem);
yopar* mzc_chnl_GetInfo__getPars(void);
#ifndef mzc_chnl_GetInfo_pars
#define mzc_chnl_GetInfo_pars (mzc_chnl_GetInfo__getPars())
#endif

#ifndef mzu_PPch_GetInfo
#define mzu_PPch_GetInfo(or, ev) \
    mzc_chnl_GetInfo((mzc_chnl)(or), (ev))
#define mzu_PPch_GetInfo_nw(or, ev, ue) \
    mzc_chnl_GetInfo_nw((mzc_chnl)(or), (ev), (ue))
#define mzu_PPch_GetInfo_pars mzc_chnl_GetInfo_pars
#endif /* mzu_PPch_GetInfo */

mzc_chnlInfo mzc_chnl_Rebuild( mzc_chnl or, yoenv* ev, mzc_chnlreqx* req);
void mzc_chnl_Rebuild_nw( mzc_chnl or, yoenv* ev, mzc_chnlreqx* req, ysevt* 
  _sem);
yopar* mzc_chnl_Rebuild__getPars(void);
#ifndef mzc_chnl_Rebuild_pars
#define mzc_chnl_Rebuild_pars (mzc_chnl_Rebuild__getPars())
#endif

#ifndef mzu_PPch_Rebuild
#define mzu_PPch_Rebuild(or, ev, req) \
    mzc_chnl_Rebuild((mzc_chnl)(or), (ev), (req))
#define mzu_PPch_Rebuild_nw(or, ev, req, ue) \
    mzc_chnl_Rebuild_nw((mzc_chnl)(or), (ev), (req), (ue))
#define mzu_PPch_Rebuild_pars mzc_chnl_Rebuild_pars
#endif /* mzu_PPch_Rebuild */

void mzc_chnl_Enable( mzc_chnl or, yoenv* ev);
void mzc_chnl_Enable_nw( mzc_chnl or, yoenv* ev, ysevt* _sem);
yopar* mzc_chnl_Enable__getPars(void);
#ifndef mzc_chnl_Enable_pars
#define mzc_chnl_Enable_pars (mzc_chnl_Enable__getPars())
#endif

#ifndef mzu_PPch_Enable
#define mzu_PPch_Enable(or, ev) \
    mzc_chnl_Enable((mzc_chnl)(or), (ev))
#define mzu_PPch_Enable_nw(or, ev, ue) \
    mzc_chnl_Enable_nw((mzc_chnl)(or), (ev), (ue))
#define mzu_PPch_Enable_pars mzc_chnl_Enable_pars
#endif /* mzu_PPch_Enable */

void mzc_chnl_Disable( mzc_chnl or, yoenv* ev);
void mzc_chnl_Disable_nw( mzc_chnl or, yoenv* ev, ysevt* _sem);
yopar* mzc_chnl_Disable__getPars(void);
#ifndef mzc_chnl_Disable_pars
#define mzc_chnl_Disable_pars (mzc_chnl_Disable__getPars())
#endif

#ifndef mzu_PPch_Disable
#define mzu_PPch_Disable(or, ev) \
    mzc_chnl_Disable((mzc_chnl)(or), (ev))
#define mzu_PPch_Disable_nw(or, ev, ue) \
    mzc_chnl_Disable_nw((mzc_chnl)(or), (ev), (ue))
#define mzu_PPch_Disable_pars mzc_chnl_Disable_pars
#endif /* mzu_PPch_Disable */

void mzc_chnl_TearDown( mzc_chnl or, yoenv* ev);
void mzc_chnl_TearDown_nw( mzc_chnl or, yoenv* ev, ysevt* _sem);
yopar* mzc_chnl_TearDown__getPars(void);
#ifndef mzc_chnl_TearDown_pars
#define mzc_chnl_TearDown_pars (mzc_chnl_TearDown__getPars())
#endif

#ifndef mzu_PPch_TearDown
#define mzu_PPch_TearDown(or, ev) \
    mzc_chnl_TearDown((mzc_chnl)(or), (ev))
#define mzu_PPch_TearDown_nw(or, ev, ue) \
    mzc_chnl_TearDown_nw((mzc_chnl)(or), (ev), (ue))
#define mzu_PPch_TearDown_pars mzc_chnl_TearDown_pars
#endif /* mzu_PPch_TearDown */

#ifndef mzu_PPch__tyimpl_DEFINED
#define mzu_PPch__tyimpl_DEFINED
struct mzu_PPch__tyimpl
{
  mzc_chnlInfo (*GetInfo)( mzu_PPch, yoenv*);
  mzc_chnlInfo (*Rebuild)( mzu_PPch, yoenv*, mzc_chnlreqx*);
  void (*Enable)( mzu_PPch, yoenv*);
  void (*Disable)( mzu_PPch, yoenv*);
  void (*TearDown)( mzu_PPch, yoenv*);
};
#endif /* mzu_PPch__tyimpl_DEFINED */


/* interface mzu_PPchP declarations */
#ifndef mzu_PPchP_DECLARED
#define mzu_PPchP_DECLARED
typedef struct YCmzu_PPchP* mzu_PPchP;
yotk* mzu_PPchP__getTC(void);
#ifndef YCTC_mzu_PPchP
#define YCTC_mzu_PPchP   (mzu_PPchP__getTC())
#endif
#endif /* mzu_PPchP_DECLARED */

#ifndef mzu_PPchP_SUPP_FUNCS
#define mzu_PPchP_SUPP_FUNCS
void mzu_PPchP__free( mzu_PPchP* val, ysmff ffunc);
void mzu_PPchP__copy( mzu_PPchP* dest, mzu_PPchP* src, ysmaf afunc);
#endif /* mzu_PPchP_SUPP_FUNCS */

#ifndef mzu_PPchP_DEFINED
#define mzu_PPchP_DEFINED
struct yostub* mzu_PPchP__getStubs(void);
#define mzu_PPchP__stubs (mzu_PPchP__getStubs())
#endif /* mzu_PPchP_DEFINED */

CONST ysid* mzu_PPchP__getId(void);
#ifndef mzu_PPchP__id
#define mzu_PPchP__id   (mzu_PPchP__getId())
#endif
...
#ifndef mzu_PPchP_GetInfo
#define mzu_PPchP_GetInfo(or, ev) \
    mzc_chnlPrv_GetInfo((mzc_chnlPrv)(or), (ev))
#define mzu_PPchP_GetInfo_nw(or, ev, ue) \
    mzc_chnlPrv_GetInfo_nw((mzc_chnlPrv)(or), (ev), (ue))
#define mzu_PPchP_GetInfo_pars mzc_chnlPrv_GetInfo_pars
#endif /* mzu_PPchP_GetInfo */
...
#ifndef mzu_PPchP_Build
#define mzu_PPchP_Build(or, ev, req) \
    mzc_chnlPrv_Build((mzc_chnlPrv)(or), (ev), (req))
#define mzu_PPchP_Build_nw(or, ev, req, ue) \
    mzc_chnlPrv_Build_nw((mzc_chnlPrv)(or), (ev), (req), (ue))
#define mzu_PPchP_Build_pars mzc_chnlPrv_Build_pars
#endif /* mzu_PPchP_Build */

void mzu_PPchP_shutdown( mzu_PPchP or, yoenv* ev);
void mzu_PPchP_shutdown_nw( mzu_PPchP or, yoenv* ev, ysevt* _sem);
yopar* mzu_PPchP_shutdown__getPars(void);
#ifndef mzu_PPchP_shutdown_pars
#define mzu_PPchP_shutdown_pars (mzu_PPchP_shutdown__getPars())
#endif

#ifndef mzu_PPchP__tyimpl_DEFINED
#define mzu_PPchP__tyimpl_DEFINED
struct mzu_PPchP__tyimpl
{
  void (*shutdown)( mzu_PPchP, yoenv*);
  mzc_chnlPrvInfo (*GetInfo)( mzu_PPchP, yoenv*);
  mzc_channel (*Build)( mzu_PPchP, yoenv*, mzc_chnlreqx*);
};
#endif /* mzu_PPchP__tyimpl_DEFINED */
