/* GENERATED FILE
 * mzzm - public declarations
 * from /vobs/rts/src/inc/mzzm.idl
 */
...
yotk* mzc_circuitException__getTC(void);
...
void mzc_circuitException__copy( mzc_circuitException* dest, 
  mzc_circuitException* src, ysmaf afunc);
...
yotk* mzc_clientDeviceId__getTC(void);
...
void mzc_clientDeviceId__copy( mzc_clientDeviceId* dest, 
  mzc_clientDeviceId* src, ysmaf afunc);
...
yotk* mzc_cktreqType__getTC(void);
...
void mzc_cktreqType__copy( mzc_cktreqType* dest, mzc_cktreqType* src, ysmaf 
  afunc);
...
yotk* mzc_cktreqSym__getTC(void);
...
void mzc_cktreqSym__copy( mzc_cktreqSym* dest, mzc_cktreqSym* src, ysmaf 
  afunc);
...
yotk* mzc_cktreqAsym__getTC(void);
...
void mzc_cktreqAsym__copy( mzc_cktreqAsym* dest, mzc_cktreqAsym* src, ysmaf 
  afunc);
...
yotk* mzc_cktspecType__getTC(void);
...
void mzc_cktspecType__copy( mzc_cktspecType* dest, mzc_cktspecType* src, 
  ysmaf afunc);
...
yotk* mzz_sessionException__getTC(void);
...
void mzz_sessionException__copy( mzz_sessionException* dest, 
  mzz_sessionException* src, ysmaf afunc);
...
yotk* mzz_clientDevice__getTC(void);
...
void mzz_clientDevice__copy( mzz_clientDevice* dest, mzz_clientDevice* src, 
  ysmaf afunc);
...
yotk* mzz_resources__getTC(void);
...
void mzz_resources__copy( mzz_resources* dest, mzz_resources* src, ysmaf 
  afunc);
...
yotk* mzz_sessProperty__getTC(void);
...
#endif
#ifndef mzz_sesMgrException_DECLARED
#define mzz_sesMgrException_DECLARED
typedef ub4 mzz_sesMgrException;
yotk* mzz_sesMgrException__getTC(void);
#ifndef YCTC_mzz_sesMgrException
#define YCTC_mzz_sesMgrException   (mzz_sesMgrException__getTC())
#endif
#endif /* mzz_sesMgrException_DECLARED */

#ifndef mzz_sesMgrException_DEFINED
#define mzz_sesMgrException_DEFINED
#define mzz_sesMgrExNoSuchSession ((mzz_sesMgrException) 0)
#endif /* mzz_sesMgrException_DEFINED */

#ifndef mzz_sesMgrException_SUPP_FUNCS
#define mzz_sesMgrException_SUPP_FUNCS
void mzz_sesMgrException__free( mzz_sesMgrException* val, ysmff ffunc);
void mzz_sesMgrException__copy( mzz_sesMgrException* dest, 
  mzz_sesMgrException* src, ysmaf afunc);
#endif /* mzz_sesMgrException_SUPP_FUNCS */

#ifndef MZZ_EX_SESMGREX_DECLARED
#define MZZ_EX_SESMGREX_DECLARED
CONST ysid* mzz_sesMgrEx__getId(void);
#ifndef MZZ_EX_SESMGREX
#define MZZ_EX_SESMGREX   (mzz_sesMgrEx__getId())
#endif
#endif /* MZZ_EX_SESMGREX_DECLARED */

#ifndef mzz_sesMgrEx_DECLARED
#define mzz_sesMgrEx_DECLARED
typedef struct mzz_sesMgrEx mzz_sesMgrEx;
#endif /* mzz_sesMgrEx_DECLARED */

#ifndef mzz_sesMgrEx_DEFINED
#define mzz_sesMgrEx_DEFINED
struct mzz_sesMgrEx
{
  mzz_sesMgrException sesMgrFailType;
};
yotk* mzz_sesMgrEx__getTC(void);
#ifndef YCTC_mzz_sesMgrEx
#define YCTC_mzz_sesMgrEx   (mzz_sesMgrEx__getTC())
#endif
#endif /* mzz_sesMgrEx_DEFINED */

#ifndef mzz_sesMgrEx_SUPP_FUNCS
#define mzz_sesMgrEx_SUPP_FUNCS
void mzz_sesMgrEx__free( mzz_sesMgrEx* val, ysmff ffunc);
void mzz_sesMgrEx__copy( mzz_sesMgrEx* dest, mzz_sesMgrEx* src, ysmaf afunc)
  ;
#endif /* mzz_sesMgrEx_SUPP_FUNCS */


/* interface mzz_sesMgr declarations */
#ifndef mzz_sesMgr_DECLARED
#define mzz_sesMgr_DECLARED
typedef struct YCmzz_sesMgr* mzz_sesMgr;
yotk* mzz_sesMgr__getTC(void);
#ifndef YCTC_mzz_sesMgr
#define YCTC_mzz_sesMgr   (mzz_sesMgr__getTC())
#endif
#endif /* mzz_sesMgr_DECLARED */

#ifndef mzz_sesMgr_SUPP_FUNCS
#define mzz_sesMgr_SUPP_FUNCS
void mzz_sesMgr__free( mzz_sesMgr* val, ysmff ffunc);
void mzz_sesMgr__copy( mzz_sesMgr* dest, mzz_sesMgr* src, ysmaf afunc);
#endif /* mzz_sesMgr_SUPP_FUNCS */

#ifndef mzz_sesMgr_DEFINED
#define mzz_sesMgr_DEFINED
struct yostub* mzz_sesMgr__getStubs(void);
#define mzz_sesMgr__stubs (mzz_sesMgr__getStubs())
#endif /* mzz_sesMgr_DEFINED */

CONST ysid* mzz_sesMgr__getId(void);
#ifndef mzz_sesMgr__id
#define mzz_sesMgr__id   (mzz_sesMgr__getId())
#endif
mzz_session mzz_factory_AllocateSession( mzz_factory or, yoenv* ev, 
  mzz_sessProperty props, mzc_clientDeviceId* clientId, mzc_cktspec* req);
void mzz_factory_AllocateSession_nw( mzz_factory or, yoenv* ev, 
  mzz_sessProperty props, mzc_clientDeviceId* clientId, mzc_cktspec* req, 
  ysevt* _sem);
yopar* mzz_factory_AllocateSession__getPars(void);
#ifndef mzz_factory_AllocateSession_pars
#define mzz_factory_AllocateSession_pars ( \
  mzz_factory_AllocateSession__getPars())
#endif

#ifndef mzz_sesMgr_AllocateSession
#define mzz_sesMgr_AllocateSession(or, ev, props, clientId, req) \
    mzz_factory_AllocateSession((mzz_factory)(or), (ev), (props), (clientId) \
  , (req))
#define mzz_sesMgr_AllocateSession_nw(or, ev, props, clientId, req, ue) \
    mzz_factory_AllocateSession_nw((mzz_factory)(or), (ev), (props), ( \
  clientId), (req), (ue))
#define mzz_sesMgr_AllocateSession_pars mzz_factory_AllocateSession_pars
#endif /* mzz_sesMgr_AllocateSession */

mzz_sessions mzz_sesMgr_GetSessions( mzz_sesMgr or, yoenv* ev, ub4 len, 
  ub4* count, ub4* total);
void mzz_sesMgr_GetSessions_nw( mzz_sesMgr or, yoenv* ev, ub4 len, ub4* 
  count, ub4* total, ysevt* _sem);
yopar* mzz_sesMgr_GetSessions__getPars(void);
#ifndef mzz_sesMgr_GetSessions_pars
#define mzz_sesMgr_GetSessions_pars (mzz_sesMgr_GetSessions__getPars())
#endif

mzz_sessions mzz_sesMgr_GetNextSessions( mzz_sesMgr or, yoenv* ev, mzz_ses 
  start, ub4 len, ub4* count, ub4* total);
void mzz_sesMgr_GetNextSessions_nw( mzz_sesMgr or, yoenv* ev, mzz_ses start,
   ub4 len, ub4* count, ub4* total, ysevt* _sem);
yopar* mzz_sesMgr_GetNextSessions__getPars(void);
#ifndef mzz_sesMgr_GetNextSessions_pars
#define mzz_sesMgr_GetNextSessions_pars ( \
  mzz_sesMgr_GetNextSessions__getPars())
#endif

mzz_session mzz_sesMgr_QryByClientId( mzz_sesMgr or, yoenv* ev, 
  mzc_clientDeviceId* key);
void mzz_sesMgr_QryByClientId_nw( mzz_sesMgr or, yoenv* ev, 
  mzc_clientDeviceId* key, ysevt* _sem);
yopar* mzz_sesMgr_QryByClientId__getPars(void);
#ifndef mzz_sesMgr_QryByClientId_pars
#define mzz_sesMgr_QryByClientId_pars (mzz_sesMgr_QryByClientId__getPars())
#endif

mzz_sessions mzz_sesMgr_QryByCircuit( mzz_sesMgr or, yoenv* ev, mzc_ckt key)
  ;
void mzz_sesMgr_QryByCircuit_nw( mzz_sesMgr or, yoenv* ev, mzc_ckt key, 
  ysevt* _sem);
yopar* mzz_sesMgr_QryByCircuit__getPars(void);
#ifndef mzz_sesMgr_QryByCircuit_pars
#define mzz_sesMgr_QryByCircuit_pars (mzz_sesMgr_QryByCircuit__getPars())
#endif

mzz_sessions mzz_sesMgr_QryByResource( mzz_sesMgr or, yoenv* ev, char* key);
  
void mzz_sesMgr_QryByResource_nw( mzz_sesMgr or, yoenv* ev, char* key, 
  ysevt* _sem);
yopar* mzz_sesMgr_QryByResource__getPars(void);
#ifndef mzz_sesMgr_QryByResource_pars
#define mzz_sesMgr_QryByResource_pars (mzz_sesMgr_QryByResource__getPars())
#endif

#ifndef mzz_sesMgr__tyimpl_DEFINED
#define mzz_sesMgr__tyimpl_DEFINED
struct mzz_sesMgr__tyimpl
{
  mzz_sessions (*GetSessions)( mzz_sesMgr, yoenv*, ub4, ub4*, ub4*);
  mzz_sessions (*GetNextSessions)( mzz_sesMgr, yoenv*, mzz_ses, ub4, ub4*, 
    ub4*);
  mzz_session (*QryByClientId)( mzz_sesMgr, yoenv*, mzc_clientDeviceId*);
  mzz_sessions (*QryByCircuit)( mzz_sesMgr, yoenv*, mzc_ckt);
  mzz_sessions (*QryByResource)( mzz_sesMgr, yoenv*, char*);
  mzz_session (*AllocateSession)( mzz_sesMgr, yoenv*, mzz_sessProperty, 
    mzc_clientDeviceId*, mzc_cktspec*);
};
#endif /* mzz_sesMgr__tyimpl_DEFINED */
