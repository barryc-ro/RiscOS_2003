...
static CONST_DATA yotk mkd_assetCookie__tc[] = 
  {0x00,0x00,0x00,0x15,0x00,0x00,0x00,'@',0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x18,'I','D','L',':','m','k','d','/','a','s',
  's','e','t','C','o','o','k','i','e',':','1','.','0',0x00,0x00
  ,0x00,0x00,0x13,':',':','m','k','d',':',':','a','s','s','e',
  't','C','o','o','k','i','e',0x00,0x00,0x00,0x00,0x00,0x12,0x00
  ,0x00,0x00,0x00};

yotk* mkd_assetCookie__getTC(void)
{
  return (yotk*)mkd_assetCookie__tc;
}

static CONST_DATA yotk mkd_assetCookieList__tc[] = 
  {0x00,0x00,0x00,0x15,0x00,0x00,0x00,'X',0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x1c,'I','D','L',':','m','k','d','/','a','s',
  's','e','t','C','o','o','k','i','e','L','i','s','t',':','1',
  '.','0',0x00,0x00,0x00,0x00,0x17,':',':','m','k','d',':',':'
...
{
  return (yotk*)mkd_assetCookieList__tc;
}

void mkd_assetCookieList__free( mkd_assetCookieList* val, ysmff ffunc)
{
  yotkFreeVal( YCTC_mkd_assetCookieList, (dvoid *)val, ffunc);
}

void mkd_assetCookieList__copy( mkd_assetCookieList* dest, 
  mkd_assetCookieList* src, ysmaf afunc)
{
  yotkCopyVal( YCTC_mkd_assetCookieList, (dvoid *)dest, (dvoid *)src, afunc)
    ;
}

static CONST_DATA yotk mkd_systemTime__tc[] = 
  {0x00,0x00,0x00,0x15,0x00,0x00,0x00,'<',0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x17,'I','D','L',':','m','k','d','/','s','y',
  's','t','e','m','T','i','m','e',':','1','.','0',0x00,0x00,0x00
  ,0x00,0x00,0x12,':',':','m','k','d',':',':','s','y','s','t',
  'e','m','T','i','m','e',0x00,0x00,0x00,0x00,0x00,0x00,0x03};

yotk* mkd_systemTime__getTC(void)
{
  return (yotk*)mkd_systemTime__tc;
}

static CONST_DATA yotk mkd_segCapMask__tc[] = 
  {0x00,0x00,0x00,0x15,0x00,0x00,0x00,'<',0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x17,'I','D','L',':','m','k','d','/','s','e',
  'g','C','a','p','M','a','s','k',':','1','.','0',0x00,0x00,0x00
  ,0x00,0x00,0x12,':',':','m','k','d',':',':','s','e','g','C',
  'a','p','M','a','s','k',0x00,0x00,0x00,0x00,0x00,0x00,0x05};

yotk* mkd_segCapMask__getTC(void)
{
  return (yotk*)mkd_segCapMask__tc;
}

static CONST_DATA yotk mkd_contStatus__tc[] = 
  {0x00,0x00,0x00,0x11,0x00,0x00,0x00,0xaa,0x00,0x00,0x00,0x00
  ,0x00,0x00,0x00,0x17,'I','D','L',':','m','k','d','/','c','o'
  ,'n','t','S','t','a','t','u','s',':','1','.','0',0x00,0x00,0x00
  ,0x00,0x00,0x12,':',':','m','k','d',':',':','c','o','n','t',
  'S','t','a','t','u','s',0x00,0x00,0x00,0x00,0x00,0x00,0x05,0x00
  ,0x00,0x00,0x0f,'c','o','n','t','S','t','a','t','u','s','D',
  'i','s','k',0x00,0x00,0x00,0x00,0x00,0x0f,'c','o','n','t','S'
  ,'t','a','t','u','s','T','a','p','e',0x00,0x00,0x00,0x00,0x00
  ,0x0f,'c','o','n','t','S','t','a','t','u','s','F','e','e','d'
  ,0x00,0x00,0x00,0x00,0x00,0x12,'c','o','n','t','S','t','a','t'
  ,'u','s','R','o','l','l','i','n','g',0x00,0x00,0x00,0x00,0x00
  ,0x00,0x16,'c','o','n','t','S','t','a','t','u','s','U','n','a'
  ,'v','a','i','l','a','b','l','e',0x00};

yotk* mkd_contStatus__getTC(void)
{
  return (yotk*)mkd_contStatus__tc;
}

void mkd_contStatus__free( mkd_contStatus* val, ysmff ffunc)
{
  yotkFreeVal( YCTC_mkd_contStatus, (dvoid *)val, ffunc);
}

void mkd_contStatus__copy( mkd_contStatus* dest, mkd_contStatus* src, ysmaf 
  afunc)
{
  yotkCopyVal( YCTC_mkd_contStatus, (dvoid *)dest, (dvoid *)src, afunc);
}

static CONST_DATA yotk mkd_compFormat__tc[] = 
  {0x00,0x00,0x00,0x15,0x00,0x00,0x00,'<',0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x17,'I','D','L',':','m','k','d','/','c','o',
  'm','p','F','o','r','m','a','t',':','1','.','0',0x00,0x00,0x00
  ,0x00,0x00,0x12,':',':','m','k','d',':',':','c','o','m','p',
  'F','o','r','m','a','t',0x00,0x00,0x00,0x00,0x00,0x00,0x05};

yotk* mkd_compFormat__getTC(void)
{
  return (yotk*)mkd_compFormat__tc;
}

static CONST_DATA yotk mkd_prohib__tc[] = 
  {0x00,0x00,0x00,0x15,0x00,0x00,0x00,'4',0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x13,'I','D','L',':','m','k','d','/','p','r',
  'o','h','i','b',':','1','.','0',0x00,0x00,0x00,0x00,0x00,0x0e
  ,':',':','m','k','d',':',':','p','r','o','h','i','b',0x00,0x00
  ,0x00,0x00,0x00,0x00,0x05};

yotk* mkd_prohib__getTC(void)
{
  return (yotk*)mkd_prohib__tc;
}

static CONST_DATA yotk mkd_posType__tc[] = 
...
{
  return (yotk*)mkd_posType__tc;
}

void mkd_posType__free( mkd_posType* val, ysmff ffunc)
{
  yotkFreeVal( YCTC_mkd_posType, (dvoid *)val, ffunc);
}

void mkd_posType__copy( mkd_posType* dest, mkd_posType* src, ysmaf afunc)
{
  yotkCopyVal( YCTC_mkd_posType, (dvoid *)dest, (dvoid *)src, afunc);
}

static CONST_DATA yotk mkd_posByte__tc[] = 
...
{
  return (yotk*)mkd_posByte__tc;
}

void mkd_posByte__free( mkd_posByte* val, ysmff ffunc)
{
  yotkFreeVal( YCTC_mkd_posByte, (dvoid *)val, ffunc);
}

void mkd_posByte__copy( mkd_posByte* dest, mkd_posByte* src, ysmaf afunc)
{
  yotkCopyVal( YCTC_mkd_posByte, (dvoid *)dest, (dvoid *)src, afunc);
}

static CONST_DATA yotk mkd_posTime__tc[] = 
...
{
  return (yotk*)mkd_posTime__tc;
}

void mkd_posTime__free( mkd_posTime* val, ysmff ffunc)
{
  yotkFreeVal( YCTC_mkd_posTime, (dvoid *)val, ffunc);
}

void mkd_posTime__copy( mkd_posTime* dest, mkd_posTime* src, ysmaf afunc)
{
  yotkCopyVal( YCTC_mkd_posTime, (dvoid *)dest, (dvoid *)src, afunc);
}

static CONST_DATA yotk mkd_posBlock__tc[] = 
  {0x00,0x00,0x00,0x15,0x00,0x00,0x00,'8',0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x15,'I','D','L',':','m','k','d','/','p','o',
  's','B','l','o','c','k',':','1','.','0',0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x10,':',':','m','k','d',':',':','p','o','s',
  'B','l','o','c','k',0x00,0x00,0x00,0x00,0x05};

yotk* mkd_posBlock__getTC(void)
{
  return (yotk*)mkd_posBlock__tc;
}

static CONST_DATA yotk mkd_posMs__tc[] = 
  {0x00,0x00,0x00,0x15,0x00,0x00,0x00,'4',0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x12,'I','D','L',':','m','k','d','/','p','o',
  's','M','s',':','1','.','0',0x00,0x00,0x00,0x00,0x00,0x00,0x0d
  ,':',':','m','k','d',':',':','p','o','s','M','s',0x00,0x00,0x00
  ,0x00,0x00,0x00,0x00,0x05};

yotk* mkd_posMs__getTC(void)
{
  return (yotk*)mkd_posMs__tc;
}

static CONST_DATA yotk mkd_posSCR__tc[] = 
  {0x00,0x00,0x00,0x15,0x00,0x00,0x00,'4',0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x13,'I','D','L',':','m','k','d','/','p','o',
  's','S','C','R',':','1','.','0',0x00,0x00,0x00,0x00,0x00,0x0e
  ,':',':','m','k','d',':',':','p','o','s','S','C','R',0x00,0x00
  ,0x00,0x00,0x00,0x00,0x17};

yotk* mkd_posSCR__getTC(void)
{
  return (yotk*)mkd_posSCR__tc;
}

static CONST_DATA yotk mkd_posPCR__tc[] = 
  {0x00,0x00,0x00,0x15,0x00,0x00,0x00,'4',0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x13,'I','D','L',':','m','k','d','/','p','o',
  's','P','C','R',':','1','.','0',0x00,0x00,0x00,0x00,0x00,0x0e
  ,':',':','m','k','d',':',':','p','o','s','P','C','R',0x00,0x00
  ,0x00,0x00,0x00,0x00,0x17};

yotk* mkd_posPCR__getTC(void)
{
  return (yotk*)mkd_posPCR__tc;
}

static CONST_DATA yotk mkd_pos__tc[] = 
  {0x00,0x00,0x00,0x10,0x00,0x00,0x07,0xfc,0x00,0x00,0x00,0x00
  ,0x00,0x00,0x00,0x10,'I','D','L',':','m','k','d','/','p','o'
  ,'s',':','1','.','0',0x00,0x00,0x00,0x00,0x0b,':',':','m','k'
  ,'d',':',':','p','o','s',0x00,0x00,0x00,0x00,0x00,0x11,0x00,
  0x00,0x01,0x20,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x14,'I','D'
  ,'L',':','m','k','d','/','p','o','s','T','y','p','e',':','1'
  ,'.','0',0x00,0x00,0x00,0x00,0x0f,':',':','m','k','d',':',':'
  ,'p','o','s','T','y','p','e',0x00,0x00,0x00,0x00,0x00,0x0c,0x00
  ,0x00,0x00,0x11,'p','o','s','T','y','p','e','B','e','g','i',
  'n','n','i','n','g',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0f,
  'p','o','s','T','y','p','e','C','u','r','r','e','n','t',0x00
  ,0x00,0x00,0x00,0x00,0x0b,'p','o','s','T','y','p','e','E','n'
  ,'d',0x00,0x00,0x00,0x00,0x00,0x0c,'p','o','s','T','y','p','e'
  ,'B','y','t','e',0x00,0x00,0x00,0x00,0x0c,'p','o','s','T','y'
  ,'p','e','T','i','m','e',0x00,0x00,0x00,0x00,0x11,'p','o','s'
  ,'T','y','p','e','M','i','l','l','i','s','e','c','s',0x00,0x00
  ,0x00,0x00,0x00,0x00,0x00,0x0f,'p','o','s','T','y','p','e','M'
  ,'p','e','g','S','C','R',0x00,0x00,0x00,0x00,0x00,0x0f,'p','o'
  ,'s','T','y','p','e','M','p','e','g','P','C','R',0x00,0x00,0x00
  ,0x00,0x00,0x0d,'p','o','s','T','y','p','e','B','l','o','c',
  'k',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0d,'p','o','s','T',
  'y','p','e','D','s','m','c','c',0x00,0x00,0x00,0x00,0x00,0x00
  ,0x00,0x10,'p','o','s','T','y','p','e','C','o','n','t','F','e'
  ,'e','d',0x00,0x00,0x00,0x00,0x10,'p','o','s','T','y','p','e'
  ,'U','n','f','o','r','m','e','d',0x00,0xff,0xff,0xff,0xff,0x00
  ,0x00,0x00,0x0c,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0d,'m',
  'k','d','_','p','o','s','B','e','g','i','n',0x00,0x00,0x00,0x00
  ,0x00,0x00,0x00,0x0f,0x00,0x00,0x00,0xa4,0x00,0x00,0x00,0x00
  ,0x00,0x00,0x00,0x14,'I','D','L',':','m','k','d','/','p','o'
  ,'s','T','i','m','e',':','1','.','0',0x00,0x00,0x00,0x00,0x0f
  ,':',':','m','k','d',':',':','p','o','s','T','i','m','e',0x00
  ...
  0x0b,'m','k','d','_','p','o','s','E','n','d',0x00,0x00,0x00,
  0x00,0x00,0x0f,0x00,0x00,0x00,0xa4,0x00,0x00,0x00,0x00,0x00,
  ...
  ,0x00,0x00,0x00,0x0a,0x00,0x00,0x00,0x03,0x00,0x00,0x00,0x0f
  ,'m','k','d','_','p','o','s','B','y','t','e','P','o','s',0x00
  ,0x00,0x00,0x00,0x00,0x0f,0x00,0x00,0x00,'L',0x00,0x00,0x00,
  0x00,0x00,0x00,0x00,0x14,'I','D','L',':','m','k','d','/','p'
  ,'o','s','B','y','t','e',':','1','.','0',0x00,0x00,0x00,0x00
  ,0x0f,':',':','m','k','d',':',':','p','o','s','B','y','t','e'
  ,0x00,0x00,0x00,0x00,0x00,0x01,0x00,0x00,0x00,0x0f,'m','k','d'
  ,'_','p','o','s','B','y','t','e','O','f','f',0x00,0x00,0x00,
  0x00,0x00,0x17,0x00,0x00,0x00,0x04,0x00,0x00,0x00,0x0f,'m','k'
  ,'d','_','p','o','s','T','i','m','e','P','o','s',0x00,0x00,0x00
  ,0x00,0x00,0x0f,0x00,0x00,0x00,0xa4,0x00,0x00,0x00,0x00,0x00
  ,0x00,0x00,0x14,'I','D','L',':','m','k','d','/','p','o','s',
  'T','i','m','e',':','1','.','0',0x00,0x00,0x00,0x00,0x0f,':'
  ,':','m','k','d',':',':','p','o','s','T','i','m','e',0x00,0x00
...
{
  return (yotk*)mkd_pos__tc;
}

void mkd_pos__free( mkd_pos* val, ysmff ffunc)
{
  yotkFreeVal( YCTC_mkd_pos, (dvoid *)val, ffunc);
}

void mkd_pos__copy( mkd_pos* dest, mkd_pos* src, ysmaf afunc)
{
  yotkCopyVal( YCTC_mkd_pos, (dvoid *)dest, (dvoid *)src, afunc);
}

static CONST_DATA yotk mkd_segMask__tc[] = 
  {0x00,0x00,0x00,0x15,0x00,0x00,0x00,'4',0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x14,'I','D','L',':','m','k','d','/','s','e',
  'g','M','a','s','k',':','1','.','0',0x00,0x00,0x00,0x00,0x0f
  ,':',':','m','k','d',':',':','s','e','g','M','a','s','k',0x00
  ,0x00,0x00,0x00,0x00,0x05};

yotk* mkd_segMask__getTC(void)
{
  return (yotk*)mkd_segMask__tc;
}

static CONST_DATA yotk mkd_segment__tc[] = 
  {0x00,0x00,0x00,0x0f,0x00,0x00,0x11,0x18,0x00,0x00,0x00,0x00
  ,0x00,0x00,0x00,0x14,'I','D','L',':','m','k','d','/','s','e'
  ,'g','m','e','n','t',':','1','.','0',0x00,0x00,0x00,0x00,0x0f
  ,':',':','m','k','d',':',':','s','e','g','m','e','n','t',0x00
  ,0x00,0x00,0x00,0x00,0x05,0x00,0x00,0x00,0x0c,'m','k','d','_'
  ,'s','e','g','F','i','l','e',0x00,0x00,0x00,0x00,0x12,0x00,0x00
  ,0x00,0x00,0x00,0x00,0x00,0x0d,'m','k','d','_','s','e','g','S'
  ,'t','a','r','t',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x10,0x00
  ,0x00,0x07,0xfc,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x10,'I',
  'D','L',':','m','k','d','/','p','o','s',':','1','.','0',0x00
  ,0x00,0x00,0x00,0x0b,':',':','m','k','d',':',':','p','o','s'
  ,0x00,0x00,0x00,0x00,0x00,0x11,0x00,0x00,0x01,0x20,0x00,0x00
  ,0x00,0x00,0x00,0x00,0x00,0x14,'I','D','L',':','m','k','d','/'
  ,'p','o','s','T','y','p','e',':','1','.','0',0x00,0x00,0x00,
  0x00,0x0f,':',':','m','k','d',':',':','p','o','s','T','y','p'
  ,'e',0x00,0x00,0x00,0x00,0x00,0x0c,0x00,0x00,0x00,0x11,'p','o'
  ,'s','T','y','p','e','B','e','g','i','n','n','i','n','g',0x00
  ,0x00,0x00,0x00,0x00,0x00,0x00,0x0f,'p','o','s','T','y','p',
  'e','C','u','r','r','e','n','t',0x00,0x00,0x00,0x00,0x00,0x0b
  ,'p','o','s','T','y','p','e','E','n','d',0x00,0x00,0x00,0x00
  ,0x00,0x0c,'p','o','s','T','y','p','e','B','y','t','e',0x00,
  0x00,0x00,0x00,0x0c,'p','o','s','T','y','p','e','T','i','m',
  'e',0x00,0x00,0x00,0x00,0x11,'p','o','s','T','y','p','e','M'
  ,'i','l','l','i','s','e','c','s',0x00,0x00,0x00,0x00,0x00,0x00
  ,0x00,0x0f,'p','o','s','T','y','p','e','M','p','e','g','S','C'
  ,'R',0x00,0x00,0x00,0x00,0x00,0x0f,'p','o','s','T','y','p','e'
  ,'M','p','e','g','P','C','R',0x00,0x00,0x00,0x00,0x00,0x0d,'p'
  ,'o','s','T','y','p','e','B','l','o','c','k',0x00,0x00,0x00,
  0x00,0x00,0x00,0x00,0x0d,'p','o','s','T','y','p','e','D','s'
  ,'m','c','c',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x10,'p','o'
  ,'s','T','y','p','e','C','o','n','t','F','e','e','d',0x00,0x00
  ,0x00,0x00,0x10,'p','o','s','T','y','p','e','U','n','f','o',
  'r','m','e','d',0x00,0xff,0xff,0xff,0xff,0x00,0x00,0x00,0x0c
  ,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0d,'m','k','d','_','p'
  ,'o','s','B','e','g','i','n',0x00,0x00,0x00,0x00,0x00,0x00,0x00
  ,0x0f,0x00,0x00,0x00,0xa4,0x00,0x00,0x00,0x00,0x00,0x00,0x00
  ,0x14,'I','D','L',':','m','k','d','/','p','o','s','T','i','m'
  ,'e',':','1','.','0',0x00,0x00,0x00,0x00,0x0f,':',':','m','k'
  ,'d',':',':','p','o','s','T','i','m','e',0x00,0x00,0x00,0x00
  ,0x00,0x04,0x00,0x00,0x00,0x10,'m','k','d','_','p','o','s','T'
  ,'i','m','e','H','o','u','r',0x00,0x00,0x00,0x00,0x05,0x00,0x00
  ,0x00,0x12,'m','k','d','_','p','o','s','T','i','m','e','M','i'
  ,'n','u','t','e',0x00,0x00,0x00,0x00,0x00,0x00,0x0a,0x00,0x00
  ,0x00,0x12,'m','k','d','_','p','o','s','T','i','m','e','S','e'
  ,'c','o','n','d',0x00,0x00,0x00,0x00,0x00,0x00,0x0a,0x00,0x00
  ,0x00,0x15,'m','k','d','_','p','o','s','T','i','m','e','H','u'
  ,'n','d','r','e','d','t','h',0x00,0x00,0x00,0x00,0x00,0x00,0x00
  ,0x0a,0x00,0x00,0x00,0x01,0x00,0x00,0x00,0x0b,'m','k','d','_'
  ,'p','o','s','C','u','r',0x00,0x00,0x00,0x00,0x00,0x0f,0x00,
  0x00,0x00,0xa4,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x14,'I','D'
  ,'L',':','m','k','d','/','p','o','s','T','i','m','e',':','1'
  ,'.','0',0x00,0x00,0x00,0x00,0x0f,':',':','m','k','d',':',':'
  ,'p','o','s','T','i','m','e',0x00,0x00,0x00,0x00,0x00,0x04,0x00
  ,0x00,0x00,0x10,'m','k','d','_','p','o','s','T','i','m','e',
  'H','o','u','r',0x00,0x00,0x00,0x00,0x05,0x00,0x00,0x00,0x12
  ,'m','k','d','_','p','o','s','T','i','m','e','M','i','n','u'
  ,'t','e',0x00,0x00,0x00,0x00,0x00,0x00,0x0a,0x00,0x00,0x00,0x12
  ,'m','k','d','_','p','o','s','T','i','m','e','S','e','c','o'
  ,'n','d',0x00,0x00,0x00,0x00,0x00,0x00,0x0a,0x00,0x00,0x00,0x15
  ,'m','k','d','_','p','o','s','T','i','m','e','H','u','n','d'
  ,'r','e','d','t','h',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0a
  ...
  ,0x00,0x00,0x00,0x00,0x00,0x00,0x0a,0x00,0x00,0x00,0x0b,'m',
  'k','d','_','s','e','g','E','n','d',0x00,0x00,0x00,0x00,0x00
  ...
  ,0x00,0x00,0x0a,0x00,0x00,0x00,0x15,'m','k','d','_','p','o',
  's','T','i','m','e','H','u','n','d','r','e','d','t','h',0x00
  ,0x00,0x00,0x00,0x00,0x00,0x00,0x0a,0x00,0x00,0x00,0x0d,'m',
  'k','d','_','s','e','g','F','l','a','g','s',0x00,0x00,0x00,0x00
  ,0x00,0x00,0x00,0x15,0x00,0x00,0x00,'4',0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x14,'I','D','L',':','m','k','d','/','s','e',
  'g','M','a','s','k',':','1','.','0',0x00,0x00,0x00,0x00,0x0f
  ,':',':','m','k','d',':',':','s','e','g','M','a','s','k',0x00
  ,0x00,0x00,0x00,0x00,0x05,0x00,0x00,0x00,0x0e,'m','k','d','_'
  ,'s','e','g','P','r','o','h','i','b',0x00,0x00,0x00,0x00,0x00
  ,0x00,0x15,0x00,0x00,0x00,'4',0x00,0x00,0x00,0x00,0x00,0x00,
  0x00,0x13,'I','D','L',':','m','k','d','/','p','r','o','h','i'
  ,'b',':','1','.','0',0x00,0x00,0x00,0x00,0x00,0x0e,':',':','m'
  ,'k','d',':',':','p','r','o','h','i','b',0x00,0x00,0x00,0x00
  ,0x00,0x00,0x05};

yotk* mkd_segment__getTC(void)
{
  return (yotk*)mkd_segment__tc;
}

void mkd_segment__free( mkd_segment* val, ysmff ffunc)
{
  yotkFreeVal( YCTC_mkd_segment, (dvoid *)val, ffunc);
}

void mkd_segment__copy( mkd_segment* dest, mkd_segment* src, ysmaf afunc)
{
  yotkCopyVal( YCTC_mkd_segment, (dvoid *)dest, (dvoid *)src, afunc);
}

static CONST_DATA yotk mkd_segmentList__tc[] = 
  {0x00,0x00,0x00,0x15,0x00,0x00,0x11,'h',0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x18,'I','D','L',':','m','k','d','/','s','e',
  'g','m','e','n','t','L','i','s','t',':','1','.','0',0x00,0x00
  ,0x00,0x00,0x13,':',':','m','k','d',':',':','s','e','g','m',
  'e','n','t','L','i','s','t',0x00,0x00,0x00,0x00,0x00,0x13,0x00
  ,0x00,0x11,'(',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0f,0x00,
  0x00,0x11,0x18,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x14,'I','D'
  ,'L',':','m','k','d','/','s','e','g','m','e','n','t',':','1'
  ,'.','0',0x00,0x00,0x00,0x00,0x0f,':',':','m','k','d',':',':'
  ,'s','e','g','m','e','n','t',0x00,0x00,0x00,0x00,0x00,0x05,0x00
  ,0x00,0x00,0x0c,'m','k','d','_','s','e','g','F','i','l','e',
  0x00,0x00,0x00,0x00,0x12,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
  0x0d,'m','k','d','_','s','e','g','S','t','a','r','t',0x00,0x00
...
{
  return (yotk*)mkd_segmentList__tc;
}

void mkd_segmentList__free( mkd_segmentList* val, ysmff ffunc)
{
  yotkFreeVal( YCTC_mkd_segmentList, (dvoid *)val, ffunc);
}

void mkd_segmentList__copy( mkd_segmentList* dest, mkd_segmentList* src, 
  ysmaf afunc)
{
  yotkCopyVal( YCTC_mkd_segmentList, (dvoid *)dest, (dvoid *)src, afunc);
}

static CONST_DATA yotk mkd_segInfo__tc[] = 
  {0x00,0x00,0x00,0x0f,0x00,0x00,0x14,0xdc,0x00,0x00,0x00,0x00
  ,0x00,0x00,0x00,0x14,'I','D','L',':','m','k','d','/','s','e'
  ,'g','I','n','f','o',':','1','.','0',0x00,0x00,0x00,0x00,0x0f
  ,':',':','m','k','d',':',':','s','e','g','I','n','f','o',0x00
  ,0x00,0x00,0x00,0x00,0x12,0x00,0x00,0x00,0x0f,'m','k','d','_'
  ,'s','e','g','I','n','f','o','S','e','g',0x00,0x00,0x00,0x00
  ,0x00,0x0f,0x00,0x00,0x11,0x18,0x00,0x00,0x00,0x00,0x00,0x00
  ,0x00,0x14,'I','D','L',':','m','k','d','/','s','e','g','m','e'
  ,'n','t',':','1','.','0',0x00,0x00,0x00,0x00,0x0f,':',':','m'
  ,'k','d',':',':','s','e','g','m','e','n','t',0x00,0x00,0x00,
  0x00,0x00,0x05,0x00,0x00,0x00,0x0c,'m','k','d','_','s','e','g'
  ,'F','i','l','e',0x00,0x00,0x00,0x00,0x12,0x00,0x00,0x00,0x00
  ,0x00,0x00,0x00,0x0d,'m','k','d','_','s','e','g','S','t','a'
  ,'r','t',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x10,0x00,0x00,0x07
  ...
  ,'b',':','1','.','0',0x00,0x00,0x00,0x00,0x00,0x0e,':',':','m'
  ,'k','d',':',':','p','r','o','h','i','b',0x00,0x00,0x00,0x00
  ,0x00,0x00,0x05,0x00,0x00,0x00,0x10,'m','k','d','_','s','e',
  'g','I','n','f','o','T','y','p','e',0x00,0x00,0x00,0x00,0x12
  ,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0d,'m','k','d','_','s'
  ,'e','g','T','i','t','l','e',0x00,0x00,0x00,0x00,0x00,0x00,0x00
  ,0x12,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x12,'m','k','d','_'
  ,'s','e','g','C','r','e','a','t','e','T','i','m','e',0x00,0x00
  ,0x00,0x00,0x00,0x00,0x15,0x00,0x00,0x00,'<',0x00,0x00,0x00,
  0x00,0x00,0x00,0x00,0x17,'I','D','L',':','m','k','d','/','s'
  ,'y','s','t','e','m','T','i','m','e',':','1','.','0',0x00,0x00
  ,0x00,0x00,0x00,0x12,':',':','m','k','d',':',':','s','y','s'
  ,'t','e','m','T','i','m','e',0x00,0x00,0x00,0x00,0x00,0x00,0x03
  ,0x00,0x00,0x00,0x0f,'m','k','d','_','s','e','g','B','i','t'
  ,'r','a','t','e',0x00,0x00,0x00,0x00,0x00,0x05,0x00,0x00,0x00
  ,0x10,'m','k','d','_','s','e','g','P','r','e','s','R','a','t'
  ,'e',0x00,0x00,0x00,0x00,0x03,0x00,0x00,0x00,0x0e,'m','k','d'
  ,'_','s','e','g','C','m','p','F','m','t',0x00,0x00,0x00,0x00
  ,0x00,0x00,0x15,0x00,0x00,0x00,'<',0x00,0x00,0x00,0x00,0x00,
  0x00,0x00,0x17,'I','D','L',':','m','k','d','/','c','o','m','p'
  ,'F','o','r','m','a','t',':','1','.','0',0x00,0x00,0x00,0x00
  ,0x00,0x12,':',':','m','k','d',':',':','c','o','m','p','F','o'
  ,'r','m','a','t',0x00,0x00,0x00,0x00,0x00,0x00,0x05,0x00,0x00
  ,0x00,0x14,'m','k','d','_','s','e','g','C','a','p','a','b','i'
  ,'l','i','t','i','e','s',0x00,0x00,0x00,0x00,0x15,0x00,0x00,
  0x00,'<',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x17,'I','D','L'
  ,':','m','k','d','/','s','e','g','C','a','p','M','a','s','k'
  ,':','1','.','0',0x00,0x00,0x00,0x00,0x00,0x12,':',':','m','k'
  ,'d',':',':','s','e','g','C','a','p','M','a','s','k',0x00,0x00
  ,0x00,0x00,0x00,0x00,0x05,0x00,0x00,0x00,0x14,'m','k','d','_'
  ,'s','e','g','M','i','l','l','i','s','e','c','o','n','d','s'
  ,0x00,0x00,0x00,0x00,0x05,0x00,0x00,0x00,0x12,'m','k','d','_'
  ,'s','e','g','B','y','t','e','L','e','n','g','t','h',0x00,0x00
  ,0x00,0x00,0x00,0x00,0x17,0x00,0x00,0x00,0x13,'m','k','d','_'
  ,'s','e','g','F','r','a','m','e','H','e','i','g','h','t',0x00
  ,0x00,0x00,0x00,0x00,0x04,0x00,0x00,0x00,0x12,'m','k','d','_'
  ,'s','e','g','F','r','a','m','e','W','i','d','t','h',0x00,0x00
  ,0x00,0x00,0x00,0x00,0x04,0x00,0x00,0x00,0x13,'m','k','d','_'
  ,'s','e','g','A','s','p','e','c','t','R','a','t','i','o',0x00
  ,0x00,0x00,0x00,0x00,0x03,0x00,0x00,0x00,0x11,'m','k','d','_'
  ,'s','e','g','F','r','a','m','e','R','a','t','e',0x00,0x00,0x00
  ,0x00,0x00,0x00,0x00,0x05,0x00,0x00,0x00,0x12,'m','k','d','_'
  ,'s','e','g','I','n','f','o','S','t','a','r','t','T',0x00,0x00
  ,0x00,0x00,0x00,0x00,0x17,0x00,0x00,0x00,0x10,'m','k','d','_'
  ,'s','e','g','I','n','f','o','E','n','d','T',0x00,0x00,0x00,
  0x00,0x17,0x00,0x00,0x00,0x11,'m','k','d','_','s','e','g','I'
  ,'n','f','o','C','S','t','a','t',0x00,0x00,0x00,0x00,0x00,0x00
  ...
  ,'l','a','b','l','e',0x00,0x00,0x00,0x00,0x00,0x00,0x14,'m',
  'k','d','_','s','e','g','P','r','o','h','i','b','i','t','i',
  'o','n','s',0x00,0x00,0x00,0x00,0x15,0x00,0x00,0x00,'4',0x00
  ,0x00,0x00,0x00,0x00,0x00,0x00,0x13,'I','D','L',':','m','k',
  'd','/','p','r','o','h','i','b',':','1','.','0',0x00,0x00,0x00
  ,0x00,0x00,0x0e,':',':','m','k','d',':',':','p','r','o','h',
  'i','b',0x00,0x00,0x00,0x00,0x00,0x00,0x05};

yotk* mkd_segInfo__getTC(void)
{
  return (yotk*)mkd_segInfo__tc;
}

void mkd_segInfo__free( mkd_segInfo* val, ysmff ffunc)
{
  yotkFreeVal( YCTC_mkd_segInfo, (dvoid *)val, ffunc);
}

void mkd_segInfo__copy( mkd_segInfo* dest, mkd_segInfo* src, ysmaf afunc)
{
  yotkCopyVal( YCTC_mkd_segInfo, (dvoid *)dest, (dvoid *)src, afunc);
}

static CONST_DATA yotk mkd_segInfoList__tc[] = 
  {0x00,0x00,0x00,0x15,0x00,0x00,0x15,',',0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x18,'I','D','L',':','m','k','d','/','s','e',
  'g','I','n','f','o','L','i','s','t',':','1','.','0',0x00,0x00
  ,0x00,0x00,0x13,':',':','m','k','d',':',':','s','e','g','I',
  'n','f','o','L','i','s','t',0x00,0x00,0x00,0x00,0x00,0x13,0x00
  ,0x00,0x14,0xec,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0f,0x00
  ,0x00,0x14,0xdc,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x14,'I',
  'D','L',':','m','k','d','/','s','e','g','I','n','f','o',':',
  '1','.','0',0x00,0x00,0x00,0x00,0x0f,':',':','m','k','d',':'
  ,':','s','e','g','I','n','f','o',0x00,0x00,0x00,0x00,0x00,0x12
  ,0x00,0x00,0x00,0x0f,'m','k','d','_','s','e','g','I','n','f'
  ,'o','S','e','g',0x00,0x00,0x00,0x00,0x00,0x0f,0x00,0x00,0x11
  ...
  ,'/','p','r','o','h','i','b',':','1','.','0',0x00,0x00,0x00,
  0x00,0x00,0x0e,':',':','m','k','d',':',':','p','r','o','h','i'
  ,'b',0x00,0x00,0x00,0x00,0x00,0x00,0x05,0x00,0x00,0x00,0x10,
  'm','k','d','_','s','e','g','I','n','f','o','T','y','p','e',
  0x00,0x00,0x00,0x00,0x12,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
  0x0d,'m','k','d','_','s','e','g','T','i','t','l','e',0x00,0x00
  ,0x00,0x00,0x00,0x00,0x00,0x12,0x00,0x00,0x00,0x00,0x00,0x00
  ,0x00,0x12,'m','k','d','_','s','e','g','C','r','e','a','t','e'
  ,'T','i','m','e',0x00,0x00,0x00,0x00,0x00,0x00,0x15,0x00,0x00
  ,0x00,'<',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x17,'I','D','L'
  ,':','m','k','d','/','s','y','s','t','e','m','T','i','m','e'
  ,':','1','.','0',0x00,0x00,0x00,0x00,0x00,0x12,':',':','m','k'
  ,'d',':',':','s','y','s','t','e','m','T','i','m','e',0x00,0x00
  ,0x00,0x00,0x00,0x00,0x03,0x00,0x00,0x00,0x0f,'m','k','d','_'
  ,'s','e','g','B','i','t','r','a','t','e',0x00,0x00,0x00,0x00
  ,0x00,0x05,0x00,0x00,0x00,0x10,'m','k','d','_','s','e','g','P'
  ,'r','e','s','R','a','t','e',0x00,0x00,0x00,0x00,0x03,0x00,0x00
  ,0x00,0x0e,'m','k','d','_','s','e','g','C','m','p','F','m','t'
  ,0x00,0x00,0x00,0x00,0x00,0x00,0x15,0x00,0x00,0x00,'<',0x00,
  0x00,0x00,0x00,0x00,0x00,0x00,0x17,'I','D','L',':','m','k','d'
  ,'/','c','o','m','p','F','o','r','m','a','t',':','1','.','0'
  ,0x00,0x00,0x00,0x00,0x00,0x12,':',':','m','k','d',':',':','c'
  ,'o','m','p','F','o','r','m','a','t',0x00,0x00,0x00,0x00,0x00
  ,0x00,0x05,0x00,0x00,0x00,0x14,'m','k','d','_','s','e','g','C'
  ,'a','p','a','b','i','l','i','t','i','e','s',0x00,0x00,0x00,
  0x00,0x15,0x00,0x00,0x00,'<',0x00,0x00,0x00,0x00,0x00,0x00,0x00
  ,0x17,'I','D','L',':','m','k','d','/','s','e','g','C','a','p'
  ,'M','a','s','k',':','1','.','0',0x00,0x00,0x00,0x00,0x00,0x12
  ,':',':','m','k','d',':',':','s','e','g','C','a','p','M','a'
  ,'s','k',0x00,0x00,0x00,0x00,0x00,0x00,0x05,0x00,0x00,0x00,0x14
  ,'m','k','d','_','s','e','g','M','i','l','l','i','s','e','c'
  ,'o','n','d','s',0x00,0x00,0x00,0x00,0x05,0x00,0x00,0x00,0x12
  ,'m','k','d','_','s','e','g','B','y','t','e','L','e','n','g'
  ,'t','h',0x00,0x00,0x00,0x00,0x00,0x00,0x17,0x00,0x00,0x00,0x13
  ,'m','k','d','_','s','e','g','F','r','a','m','e','H','e','i'
  ,'g','h','t',0x00,0x00,0x00,0x00,0x00,0x04,0x00,0x00,0x00,0x12
  ,'m','k','d','_','s','e','g','F','r','a','m','e','W','i','d'
  ,'t','h',0x00,0x00,0x00,0x00,0x00,0x00,0x04,0x00,0x00,0x00,0x13
  ,'m','k','d','_','s','e','g','A','s','p','e','c','t','R','a'
  ,'t','i','o',0x00,0x00,0x00,0x00,0x00,0x03,0x00,0x00,0x00,0x11
  ,'m','k','d','_','s','e','g','F','r','a','m','e','R','a','t'
  ,'e',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x05,0x00,0x00,0x00,
  0x12,'m','k','d','_','s','e','g','I','n','f','o','S','t','a'
  ,'r','t','T',0x00,0x00,0x00,0x00,0x00,0x00,0x17,0x00,0x00,0x00
  ,0x10,'m','k','d','_','s','e','g','I','n','f','o','E','n','d'
  ,'T',0x00,0x00,0x00,0x00,0x17,0x00,0x00,0x00,0x11,'m','k','d'
  ,'_','s','e','g','I','n','f','o','C','S','t','a','t',0x00,0x00
  ,0x00,0x00,0x00,0x00,0x00,0x11,0x00,0x00,0x00,0xaa,0x00,0x00
  ,0x00,0x00,0x00,0x00,0x00,0x17,'I','D','L',':','m','k','d','/'
  ,'c','o','n','t','S','t','a','t','u','s',':','1','.','0',0x00
  ,0x00,0x00,0x00,0x00,0x12,':',':','m','k','d',':',':','c','o'
  ,'n','t','S','t','a','t','u','s',0x00,0x00,0x00,0x00,0x00,0x00
  ,0x05,0x00,0x00,0x00,0x0f,'c','o','n','t','S','t','a','t','u'
  ,'s','D','i','s','k',0x00,0x00,0x00,0x00,0x00,0x0f,'c','o','n'
  ,'t','S','t','a','t','u','s','T','a','p','e',0x00,0x00,0x00,
  0x00,0x00,0x0f,'c','o','n','t','S','t','a','t','u','s','F','e'
  ,'e','d',0x00,0x00,0x00,0x00,0x00,0x12,'c','o','n','t','S','t'
  ,'a','t','u','s','R','o','l','l','i','n','g',0x00,0x00,0x00,
  0x00,0x00,0x00,0x16,'c','o','n','t','S','t','a','t','u','s',
  'U','n','a','v','a','i','l','a','b','l','e',0x00,0x00,0x00,0x00
  ,0x00,0x00,0x14,'m','k','d','_','s','e','g','P','r','o','h',
  'i','b','i','t','i','o','n','s',0x00,0x00,0x00,0x00,0x15,0x00
  ,0x00,0x00,'4',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x13,'I','D'
  ,'L',':','m','k','d','/','p','r','o','h','i','b',':','1','.'
  ,'0',0x00,0x00,0x00,0x00,0x00,0x0e,':',':','m','k','d',':',':'
  ,'p','r','o','h','i','b',0x00,0x00,0x00,0x00,0x00,0x00,0x05,
  0x00,0x00,0x00,0x00};

yotk* mkd_segInfoList__getTC(void)
{
  return (yotk*)mkd_segInfoList__tc;
}

void mkd_segInfoList__free( mkd_segInfoList* val, ysmff ffunc)
{
  yotkFreeVal( YCTC_mkd_segInfoList, (dvoid *)val, ffunc);
}

void mkd_segInfoList__copy( mkd_segInfoList* dest, mkd_segInfoList* src, 
  ysmaf afunc)
{
  yotkCopyVal( YCTC_mkd_segInfoList, (dvoid *)dest, (dvoid *)src, afunc);
}

static CONST_DATA yotk mkd_formatCode__tc[] = 
  {0x00,0x00,0x00,0x15,0x00,0x00,0x00,'@',0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x17,'I','D','L',':','m','k','d','/','f','o',
  'r','m','a','t','C','o','d','e',':','1','.','0',0x00,0x00,0x00
  ,0x00,0x00,0x12,':',':','m','k','d',':',':','f','o','r','m',
  'a','t','C','o','d','e',0x00,0x00,0x00,0x00,0x00,0x00,0x12,0x00
  ,0x00,0x00,0x00};

yotk* mkd_formatCode__getTC(void)
{
  return (yotk*)mkd_formatCode__tc;
}

static CONST_DATA yotk mkd_contFormat__tc[] = 
  {0x00,0x00,0x00,0x0f,0x00,0x00,0x01,0xa4,0x00,0x00,0x00,0x00
  ,0x00,0x00,0x00,0x17,'I','D','L',':','m','k','d','/','c','o'
  ,'n','t','F','o','r','m','a','t',':','1','.','0',0x00,0x00,0x00
  ,0x00,0x00,0x12,':',':','m','k','d',':',':','c','o','n','t',
  'F','o','r','m','a','t',0x00,0x00,0x00,0x00,0x00,0x00,0x08,0x00
  ,0x00,0x00,0x08,'c','r','e','a','t','o','r',0x00,0x00,0x00,0x00
  ,0x12,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0a,'c','o','n','t'
  ,'a','i','n','e','r',0x00,0x00,0x00,0x00,0x00,0x00,0x15,0x00
  ...
  ,0x00,0x00,0x00,0x00,0x00,0x12,0x00,0x00,0x00,0x00,0x00,0x00
  ,0x00,0x06,'v','i','d','e','o',0x00,0x00,0x00,0x00,0x00,0x00
  ...
  ,0x00,0x00,0x00,0x00,0x00,0x0c,'f','r','a','m','e','H','e','i'
  ,'g','h','t',0x00,0x00,0x00,0x00,0x04,0x00,0x00,0x00,0x0b,'f'
  ,'r','a','m','e','W','i','d','t','h',0x00,0x00,0x00,0x00,0x00
  ,0x04,0x00,0x00,0x00,0x0f,'p','e','l','A','s','p','e','c','t'
  ,'R','a','t','i','o',0x00,0x00,0x00,0x00,0x00,0x03,0x00,0x00
  ,0x00,0x0a,'f','r','a','m','e','R','a','t','e',0x00,0x00,0x00
  ,0x00,0x00,0x00,0x05};

yotk* mkd_contFormat__getTC(void)
{
  return (yotk*)mkd_contFormat__tc;
}

void mkd_contFormat__free( mkd_contFormat* val, ysmff ffunc)
{
  yotkFreeVal( YCTC_mkd_contFormat, (dvoid *)val, ffunc);
}

void mkd_contFormat__copy( mkd_contFormat* dest, mkd_contFormat* src, ysmaf 
  afunc)
{
  yotkCopyVal( YCTC_mkd_contFormat, (dvoid *)dest, (dvoid *)src, afunc);
}
