...
static CONST_DATA yotk mzs_networkException__tc[] = 
...
{
  yotkFreeVal( YCTC_mzs_networkException, (dvoid *)val, ffunc);
}

void mzs_networkException__copy( mzs_networkException* dest, 
  mzs_networkException* src, ysmaf afunc)
{
  yotkCopyVal( YCTC_mzs_networkException, (dvoid *)dest, (dvoid *)src, 
    afunc);
}
...
static CONST_DATA yotk mzs_network__tc[] = 
...
{
  yotkFreeVal( YCTC_mzs_network, (dvoid *)val, ffunc);
}

void mzs_network__copy( mzs_network* dest, mzs_network* src, ysmaf afunc)
{
  yotkCopyVal( YCTC_mzs_network, (dvoid *)dest, (dvoid *)src, afunc);
}

static CONST_DATA yotk mzs_serverException__tc[] = 
...
{
  yotkFreeVal( YCTC_mzs_serverException, (dvoid *)val, ffunc);
}

void mzs_serverException__copy( mzs_serverException* dest, 
  mzs_serverException* src, ysmaf afunc)
{
  yotkCopyVal( YCTC_mzs_serverException, (dvoid *)dest, (dvoid *)src, afunc)
    ;
}
...
static CONST_DATA yotk mzs_server__tc[] = 
...
{
  yotkFreeVal( YCTC_mzs_server, (dvoid *)val, ffunc);
}

void mzs_server__copy( mzs_server* dest, mzs_server* src, ysmaf afunc)
{
  yotkCopyVal( YCTC_mzs_server, (dvoid *)dest, (dvoid *)src, afunc);
}

static CONST_DATA yotk mzs_clientException__tc[] = 
...
{
  yotkFreeVal( YCTC_mzs_clientException, (dvoid *)val, ffunc);
}

void mzs_clientException__copy( mzs_clientException* dest, 
  mzs_clientException* src, ysmaf afunc)
{
  yotkCopyVal( YCTC_mzs_clientException, (dvoid *)dest, (dvoid *)src, afunc)
    ;
}
...
static CONST_DATA yotk mzs_client__tc[] = 
...
{
  yotkFreeVal( YCTC_mzs_client, (dvoid *)val, ffunc);
}

void mzs_client__copy( mzs_client* dest, mzs_client* src, ysmaf afunc)
{
  yotkCopyVal( YCTC_mzs_client, (dvoid *)dest, (dvoid *)src, afunc);
}

static CONST_DATA yotk mzs_denialException__tc[] = 
...
{
  yotkFreeVal( YCTC_mzs_denialException, (dvoid *)val, ffunc);
}

void mzs_denialException__copy( mzs_denialException* dest, 
  mzs_denialException* src, ysmaf afunc)
{
  yotkCopyVal( YCTC_mzs_denialException, (dvoid *)dest, (dvoid *)src, afunc)
    ;
}
...
static CONST_DATA yotk mzs_denial__tc[] = 
...
{
  yotkFreeVal( YCTC_mzs_denial, (dvoid *)val, ffunc);
}

void mzs_denial__copy( mzs_denial* dest, mzs_denial* src, ysmaf afunc)
{
  yotkCopyVal( YCTC_mzs_denial, (dvoid *)dest, (dvoid *)src, afunc);
}

static CONST_DATA yotk mzs_capMask__tc[] = 
...
static CONST_DATA yotk mzs_mnAddr__tc[] = 
...
{
  yotkFreeVal( YCTC_mzs_mnAddr, (dvoid *)val, ffunc);
}

void mzs_mnAddr__copy( mzs_mnAddr* dest, mzs_mnAddr* src, ysmaf afunc)
{
  yotkCopyVal( YCTC_mzs_mnAddr, (dvoid *)dest, (dvoid *)src, afunc);
}

static CONST_DATA yotk mzs_state__tc[] = 
...
{
  yotkFreeVal( YCTC_mzs_state, (dvoid *)val, ffunc);
}

void mzs_state__copy( mzs_state* dest, mzs_state* src, ysmaf afunc)
{
  yotkCopyVal( YCTC_mzs_state, (dvoid *)dest, (dvoid *)src, afunc);
}

static CONST_DATA yotk mzs_stats__tc[] = 
...
{
  yotkFreeVal( YCTC_mzs_stats, (dvoid *)val, ffunc);
}

void mzs_stats__copy( mzs_stats* dest, mzs_stats* src, ysmaf afunc)
{
  yotkCopyVal( YCTC_mzs_stats, (dvoid *)dest, (dvoid *)src, afunc);
}

static CONST_DATA yotk mzs_internals__tc[] = 
  ...
  'r','n','a','l','s',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x06,
  ...
  ,0x00,0x00,0x00,0x00,0x00,0x05,0x00,0x00,0x00,0x10,'m','z','s'
  ,'_','i','n','t','P','l','a','y','R','a','t','e',0x00,0x00,0x00
  ,0x00,0x03,0x00,0x00,0x00,0x0f,'m','z','s','_','i','n','t','C'
  ,'u','r','S','e','g','s',0x00,0x00,0x00,0x00,0x00,0x15,0x00,
  0x00,0x11,'h',0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x18,'I','D'
  ,'L',':','m','k','d','/','s','e','g','m','e','n','t','L','i'
  ,'s','t',':','1','.','0',0x00,0x00,0x00,0x00,0x13,':',':','m'
  ,'k','d',':',':','s','e','g','m','e','n','t','L','i','s','t'
  ,0x00,0x00,0x00,0x00,0x00,0x13,0x00,0x00,0x11,'(',0x00,0x00,
  0x00,0x00,0x00,0x00,0x00,0x0f,0x00,0x00,0x11,0x18,0x00,0x00,
  0x00,0x00,0x00,0x00,0x00,0x14,'I','D','L',':','m','k','d','/'
  ,'s','e','g','m','e','n','t',':','1','.','0',0x00,0x00,0x00,
  0x00,0x0f,':',':','m','k','d',':',':','s','e','g','m','e','n'
  ,'t',0x00,0x00,0x00,0x00,0x00,0x05,0x00,0x00,0x00,0x0c,'m','k'
  ,'d','_','s','e','g','F','i','l','e',0x00,0x00,0x00,0x00,0x12
  ,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0d,'m','k','d','_','s'
  ,'e','g','S','t','a','r','t',0x00,0x00,0x00,0x00,0x00,0x00,0x00
...
{
  yotkFreeVal( YCTC_mzs_internals, (dvoid *)val, ffunc);
}

void mzs_internals__copy( mzs_internals* dest, mzs_internals* src, ysmaf 
  afunc)
{
  yotkCopyVal( YCTC_mzs_internals, (dvoid *)dest, (dvoid *)src, afunc);
}

static CONST_DATA yotk mzs_bootMask__tc[] = 
...
static CONST_DATA yotk mzs_stream__tc[] = 
...
{
  yotkFreeVal( YCTC_mzs_stream, (dvoid *)val, ffunc);
}

void mzs_stream__copy( mzs_stream* dest, mzs_stream* src, ysmaf afunc)
{
  yotkCopyVal( YCTC_mzs_stream, (dvoid *)dest, (dvoid *)src, afunc);
}

static CONST_DATA yotk mzs_stream_instance__tc[] = 
  {0x00,0x00,0x00,0x15,0x00,0x00,0x00,'D',0x00,0x00,0x00,0x00,
...
static CONST_DATA yotk mzs_stream_playFlags__tc[] = 
...
static CONST_DATA yotk mzs_stream_finishFlags__tc[] = 
  {0x00,0x00,0x00,0x15,0x00,0x00,0x00,'L',0x00,0x00,0x00,0x00,
...
mzs_stream_instance mzs_stream_prepare( mzs_stream or, yoenv* ev, 
  mkd_assetCookie cookie, mkd_pos* start, mkd_pos* end, ub4 bitrate, 
  mzs_stream_playFlags flags, mkd_segInfoList* status, CORBA_Object authRef)
  
{
  ...
  NOREG(_sem);
  _impl = (struct mzs_stream__tyimpl*) yoLocalObj( (CORBA_Object)or, (
    yowiden*)&_widen);
  if ( _impl )
  {
    if ( _widen )
    {
      yogfp _f = (*_widen)( (ub4)0, (dvoid *)_impl, mzs_stream__id);
      _result = (*(mzs_stream_instance (*)( mzs_stream, yoenv*, 
        mkd_assetCookie, mkd_pos*, mkd_pos*, ub4, mzs_stream_playFlags, 
        mkd_segInfoList*, CORBA_Object))_f)(or, ev, cookie, start, end, 
        bitrate, flags, status, authRef);
    }
    else
      _result = (*_impl->prepare)(or, ev, cookie, start, end, bitrate, 
        flags, status, authRef);
  }
  else
  {
    ...
    yseTry
    {
      ...
      mzs_stream_prepare_nw( or, ev, cookie, start, end, bitrate, flags, 
        status, authRef, (ysevt*)_sem);
    }
    yseCatchAll
    {
      CONST ysid* _exid;
...
void mzs_stream_prepare_nw( mzs_stream or, yoenv* ev, mkd_assetCookie 
  cookie, mkd_pos* start, mkd_pos* end, ub4 bitrate, mzs_stream_playFlags 
  flags, mkd_segInfoList* status, CORBA_Object authRef, ysevt* _sem)
{
  dvoid * _parvec[7];

  _parvec[0] = (dvoid *)&cookie;
  _parvec[1] = (dvoid *) start;
  _parvec[2] = (dvoid *) end;
  _parvec[3] = (dvoid *)&bitrate;
  _parvec[4] = (dvoid *)&flags;
  _parvec[5] = (dvoid *) status;
  _parvec[6] = (dvoid *)&authRef;
  yoSendReq( (dvoid *)or, ev, "prepare", TRUE, _sem, (sword)7, 
    mzs_stream_prepare_pars, _parvec);
}
...
mzs_stream_instance mzs_stream_prepareSequence( mzs_stream or, yoenv* ev, 
  mkd_assetCookieList* cookies, mkd_segInfoList* clipStatus, mkd_pos* 
  startPos, mkd_pos* endPos, ub4 bitrate, sb4 playRate, 
  mzs_stream_playFlags flags, mkd_prohib prohibitions, CORBA_Object authRef)
  
{
  ...
  if ( _impl )
  {
    if ( _widen )
    {
      yogfp _f = (*_widen)( (ub4)1, (dvoid *)_impl, mzs_stream__id);
      _result = (*(mzs_stream_instance (*)( mzs_stream, yoenv*, 
        mkd_assetCookieList*, mkd_segInfoList*, mkd_pos*, mkd_pos*, ub4, 
        sb4, mzs_stream_playFlags, mkd_prohib, CORBA_Object))_f)(or, ev, 
        cookies, clipStatus, startPos, endPos, bitrate, playRate, flags, 
        prohibitions, authRef);
    }
    else
      _result = (*_impl->prepareSequence)(or, ev, cookies, clipStatus, 
        startPos, endPos, bitrate, playRate, flags, prohibitions, authRef);
  }
  else
  {
    yoFilterRunEx((dvoid *)or, ev, YOFLTR_CSND, (CONST  char*)0, (dvoid *)0)
    ...
    {
      _sem = ysSemCreate((dvoid *)0);
      mzs_stream_prepareSequence_nw( or, ev, cookies, clipStatus, startPos, 
        endPos, bitrate, playRate, flags, prohibitions, authRef, (ysevt*)
        _sem);
    }
    yseCatchAll
    {
...
void mzs_stream_prepareSequence_nw( mzs_stream or, yoenv* ev, 
  mkd_assetCookieList* cookies, mkd_segInfoList* clipStatus, mkd_pos* 
  startPos, mkd_pos* endPos, ub4 bitrate, sb4 playRate, 
  mzs_stream_playFlags flags, mkd_prohib prohibitions, CORBA_Object authRef,
   ysevt* _sem)
{
  ...
  _parvec[0] = (dvoid *) cookies;
  _parvec[1] = (dvoid *) clipStatus;
  _parvec[2] = (dvoid *) startPos;
  _parvec[3] = (dvoid *) endPos;
  _parvec[4] = (dvoid *)&bitrate;
  _parvec[5] = (dvoid *)&playRate;
  _parvec[6] = (dvoid *)&flags;
  _parvec[7] = (dvoid *)&prohibitions;
  _parvec[8] = (dvoid *)&authRef;
  yoSendReq( (dvoid *)or, ev, "prepareSequence", TRUE, _sem, (sword)9, 
    mzs_stream_prepareSequence_pars, _parvec);
}
...
void mzs_stream_play( mzs_stream or, yoenv* ev, mzs_stream_instance inst, 
  mkd_pos* curPos, mkd_pos* startPos, mkd_pos* endPos, sb4 playRate, ub4 
  bitrate)
{
  ysevt* noreg _sem = (ysevt*)0;
  struct mzs_stream__tyimpl* _impl;
  ...
  if ( _impl )
  {
    if ( _widen )
    {
      yogfp _f = (*_widen)( (ub4)2, (dvoid *)_impl, mzs_stream__id);
      (*(void (*)( mzs_stream, yoenv*, mzs_stream_instance, mkd_pos*, 
        mkd_pos*, mkd_pos*, sb4, ub4))_f)(or, ev, inst, curPos, startPos, 
        endPos, playRate, bitrate);
    }
    else
      (*_impl->play)(or, ev, inst, curPos, startPos, endPos, playRate, 
        bitrate);
  }
  else
  {
    ...
    {
      _sem = ysSemCreate((dvoid *)0);
      mzs_stream_play_nw( or, ev, inst, curPos, startPos, endPos, playRate, 
        bitrate, (ysevt*)_sem);
    }
    yseCatchAll
    {
...
void mzs_stream_play_nw( mzs_stream or, yoenv* ev, mzs_stream_instance inst,
   mkd_pos* curPos, mkd_pos* startPos, mkd_pos* endPos, sb4 playRate, ub4 
  bitrate, ysevt* _sem)
{
  dvoid * _parvec[6];

  _parvec[0] = (dvoid *)&inst;
  _parvec[1] = (dvoid *) curPos;
  _parvec[2] = (dvoid *) startPos;
  _parvec[3] = (dvoid *) endPos;
  _parvec[4] = (dvoid *)&playRate;
  _parvec[5] = (dvoid *)&bitrate;
  yoSendReq( (dvoid *)or, ev, "play", TRUE, _sem, (sword)6, 
    mzs_stream_play_pars, _parvec);
}
...
void mzs_stream_pause( mzs_stream or, yoenv* ev, mzs_stream_instance inst, 
  mkd_pos* curPos)
{
  ysevt* noreg _sem = (ysevt*)0;
  struct mzs_stream__tyimpl* _impl;
  ...
  if ( _impl )
  {
    if ( _widen )
    {
      yogfp _f = (*_widen)( (ub4)3, (dvoid *)_impl, mzs_stream__id);
      (*(void (*)( mzs_stream, yoenv*, mzs_stream_instance, mkd_pos*))_f)(
        or, ev, inst, curPos);
    }
    else
...
void mzs_stream_pause_nw( mzs_stream or, yoenv* ev, mzs_stream_instance 
  inst, mkd_pos* curPos, ysevt* _sem)
{
  dvoid * _parvec[2];

  _parvec[0] = (dvoid *)&inst;
  _parvec[1] = (dvoid *) curPos;
  yoSendReq( (dvoid *)or, ev, "pause", TRUE, _sem, (sword)2, 
    mzs_stream_pause_pars, _parvec);
}
...
void mzs_stream_playFwd( mzs_stream or, yoenv* ev, mzs_stream_instance inst,
   mkd_pos* startPos, mkd_pos* endPos)
{
  ysevt* noreg _sem = (ysevt*)0;
  struct mzs_stream__tyimpl* _impl;
  yowiden _widen = (yowiden)0;
  ...
  if ( _impl )
  {
    if ( _widen )
    {
      yogfp _f = (*_widen)( (ub4)4, (dvoid *)_impl, mzs_stream__id);
      (*(void (*)( mzs_stream, yoenv*, mzs_stream_instance, mkd_pos*, 
        mkd_pos*))_f)(or, ev, inst, startPos, endPos);
    }
    else
...
void mzs_stream_playFwd_nw( mzs_stream or, yoenv* ev, mzs_stream_instance 
  inst, mkd_pos* startPos, mkd_pos* endPos, ysevt* _sem)
{
  dvoid * _parvec[3];

  _parvec[0] = (dvoid *)&inst;
  _parvec[1] = (dvoid *) startPos;
  _parvec[2] = (dvoid *) endPos;
  yoSendReq( (dvoid *)or, ev, "playFwd", TRUE, _sem, (sword)3, 
    mzs_stream_playFwd_pars, _parvec);
}
...
void mzs_stream_playRev( mzs_stream or, yoenv* ev, mzs_stream_instance inst,
   mkd_pos* startPos, mkd_pos* endPos)
{
  ysevt* noreg _sem = (ysevt*)0;
  struct mzs_stream__tyimpl* _impl;
  ...
  if ( _impl )
  {
    if ( _widen )
    {
      yogfp _f = (*_widen)( (ub4)5, (dvoid *)_impl, mzs_stream__id);
      (*(void (*)( mzs_stream, yoenv*, mzs_stream_instance, mkd_pos*, 
        mkd_pos*))_f)(or, ev, inst, startPos, endPos);
    }
    else
...
void mzs_stream_playRev_nw( mzs_stream or, yoenv* ev, mzs_stream_instance 
  inst, mkd_pos* startPos, mkd_pos* endPos, ysevt* _sem)
{
  dvoid * _parvec[3];
  ...
  _parvec[1] = (dvoid *) startPos;
  _parvec[2] = (dvoid *) endPos;
  yoSendReq( (dvoid *)or, ev, "playRev", TRUE, _sem, (sword)3, 
    mzs_stream_playRev_pars, _parvec);
}
...
void mzs_stream_frameFwd( mzs_stream or, yoenv* ev, mzs_stream_instance 
  inst, mkd_pos* curPos)
{
  ysevt* noreg _sem = (ysevt*)0;
  struct mzs_stream__tyimpl* _impl;
  ...
  if ( _impl )
  {
    if ( _widen )
    {
      yogfp _f = (*_widen)( (ub4)6, (dvoid *)_impl, mzs_stream__id);
      (*(void (*)( mzs_stream, yoenv*, mzs_stream_instance, mkd_pos*))_f)(
        or, ev, inst, curPos);
    }
    else
...
void mzs_stream_frameFwd_nw( mzs_stream or, yoenv* ev, mzs_stream_instance 
  inst, mkd_pos* curPos, ysevt* _sem)
{
  dvoid * _parvec[2];
  ...
  _parvec[0] = (dvoid *)&inst;
  _parvec[1] = (dvoid *) curPos;
  yoSendReq( (dvoid *)or, ev, "frameFwd", TRUE, _sem, (sword)2, 
    mzs_stream_frameFwd_pars, _parvec);
}
...
void mzs_stream_frameRev( mzs_stream or, yoenv* ev, mzs_stream_instance 
  inst, mkd_pos* curPos)
{
  ysevt* noreg _sem = (ysevt*)0;
  struct mzs_stream__tyimpl* _impl;
  ...
  if ( _impl )
  {
    if ( _widen )
    {
      yogfp _f = (*_widen)( (ub4)7, (dvoid *)_impl, mzs_stream__id);
      (*(void (*)( mzs_stream, yoenv*, mzs_stream_instance, mkd_pos*))_f)(
        or, ev, inst, curPos);
    }
    else
...
void mzs_stream_frameRev_nw( mzs_stream or, yoenv* ev, mzs_stream_instance 
  inst, mkd_pos* curPos, ysevt* _sem)
{
  dvoid * _parvec[2];
  ...
  _parvec[0] = (dvoid *)&inst;
  _parvec[1] = (dvoid *) curPos;
  yoSendReq( (dvoid *)or, ev, "frameRev", TRUE, _sem, (sword)2, 
    mzs_stream_frameRev_pars, _parvec);
}
...
void mzs_stream_finish( mzs_stream or, yoenv* ev, mzs_stream_instance inst, 
  mzs_stream_finishFlags flags)
{
  ysevt* noreg _sem = (ysevt*)0;
  struct mzs_stream__tyimpl* _impl;
  yowiden _widen = (yowiden)0;
  ...
  if ( _impl )
  {
    if ( _widen )
    {
      yogfp _f = (*_widen)( (ub4)8, (dvoid *)_impl, mzs_stream__id);
      (*(void (*)( mzs_stream, yoenv*, mzs_stream_instance, 
        mzs_stream_finishFlags))_f)(or, ev, inst, flags);
    }
    else
...
void mzs_stream_finish_nw( mzs_stream or, yoenv* ev, mzs_stream_instance 
  inst, mzs_stream_finishFlags flags, ysevt* _sem)
{
  dvoid * _parvec[2];

  _parvec[0] = (dvoid *)&inst;
  _parvec[1] = (dvoid *)&flags;
  yoSendReq( (dvoid *)or, ev, "finish", TRUE, _sem, (sword)2, 
    mzs_stream_finish_pars, _parvec);
}
...
void mzs_stream_bootMore( mzs_stream or, yoenv* ev, mkd_pos* startPos, 
  mkd_pos* endPos, mzs_bootMask flags)
{
  ysevt* noreg _sem = (ysevt*)0;
  struct mzs_stream__tyimpl* _impl;
  yowiden _widen = (yowiden)0;
  ...
  if ( _impl )
  {
    if ( _widen )
    {
      yogfp _f = (*_widen)( (ub4)9, (dvoid *)_impl, mzs_stream__id);
      (*(void (*)( mzs_stream, yoenv*, mkd_pos*, mkd_pos*, mzs_bootMask))_f)
        (or, ev, startPos, endPos, flags);
    }
    else
...
void mzs_stream_bootMore_nw( mzs_stream or, yoenv* ev, mkd_pos* startPos, 
  mkd_pos* endPos, mzs_bootMask flags, ysevt* _sem)
{
  dvoid * _parvec[3];

  _parvec[0] = (dvoid *) startPos;
  _parvec[1] = (dvoid *) endPos;
  _parvec[2] = (dvoid *)&flags;
  yoSendReq( (dvoid *)or, ev, "bootMore", TRUE, _sem, (sword)3, 
    mzs_stream_bootMore_pars, _parvec);
}
...
void mzs_stream_bootCancel( mzs_stream or, yoenv* ev, mkd_pos* startPos, 
  mkd_pos* endPos, ub2 cancel_err)
{
  ysevt* noreg _sem = (ysevt*)0;
  struct mzs_stream__tyimpl* _impl;
  yowiden _widen = (yowiden)0;
  ...
  if ( _impl )
  {
    if ( _widen )
    {
      yogfp _f = (*_widen)( (ub4)10, (dvoid *)_impl, mzs_stream__id);
      (*(void (*)( mzs_stream, yoenv*, mkd_pos*, mkd_pos*, ub2))_f)(or, ev, 
        startPos, endPos, cancel_err);
    }
    else
  ...
  else
  {
    ...
    {
      _sem = ysSemCreate((dvoid *)0);
      mzs_stream_bootCancel_nw( or, ev, startPos, endPos, cancel_err, (
        ysevt*)_sem);
    }
    yseCatchAll
    {
...
void mzs_stream_bootCancel_nw( mzs_stream or, yoenv* ev, mkd_pos* startPos, 
  mkd_pos* endPos, ub2 cancel_err, ysevt* _sem)
{
  dvoid * _parvec[3];

  _parvec[0] = (dvoid *) startPos;
  _parvec[1] = (dvoid *) endPos;
  _parvec[2] = (dvoid *)&cancel_err;
  yoSendReq( (dvoid *)or, ev, "bootCancel", TRUE, _sem, (sword)3, 
    mzs_stream_bootCancel_pars, _parvec);
}
...
mzs_clientCB mzs_stream_setCallback( mzs_stream or, yoenv* ev, mzs_clientCB 
  orCli)
{
  ...
  if ( _impl )
  {
    if ( _widen )
    {
      yogfp _f = (*_widen)( (ub4)11, (dvoid *)_impl, mzs_stream__id);
      _result = (*(mzs_clientCB (*)( mzs_stream, yoenv*, mzs_clientCB))_f)(
        or, ev, orCli);
    }
    else
...
void mzs_stream_setCallback_nw( mzs_stream or, yoenv* ev, mzs_clientCB 
  orCli, ysevt* _sem)
{
  dvoid * _parvec[1];

  _parvec[0] = (dvoid *)&orCli;
  yoSendReq( (dvoid *)or, ev, "setCallback", TRUE, _sem, (sword)1, 
    mzs_stream_setCallback_pars, _parvec);
}
...
mzs_clientCB mzs_stream_removeCallback( mzs_stream or, yoenv* ev)
{
  ...
  if ( _impl )
  {
    if ( _widen )
    {
      yogfp _f = (*_widen)( (ub4)12, (dvoid *)_impl, mzs_stream__id);
...
{
  yoSendReq( (dvoid *)or, ev, "removeCallback", TRUE, _sem, (sword)0, 
    mzs_stream_removeCallback_pars, (dvoid **)0);
}
...
void mzs_stream_query( mzs_stream or, yoenv* ev, mzs_internals* 
  sessionState)
{
  ysevt* noreg _sem = (ysevt*)0;
  struct mzs_stream__tyimpl* _impl;
  ...
  if ( _impl )
  {
    if ( _widen )
    {
      yogfp _f = (*_widen)( (ub4)13, (dvoid *)_impl, mzs_stream__id);
      (*(void (*)( mzs_stream, yoenv*, mzs_internals*))_f)(or, ev, 
        sessionState);
    }
    else
...
void mzs_stream_query_nw( mzs_stream or, yoenv* ev, mzs_internals* 
  sessionState, ysevt* _sem)
{
  dvoid * _parvec[1];

  _parvec[0] = (dvoid *) sessionState;
  yoSendReq( (dvoid *)or, ev, "query", TRUE, _sem, (sword)1, 
    mzs_stream_query_pars, _parvec);
}
...
mkd_pos mzs_stream_getPos( mzs_stream or, yoenv* ev, mzs_stream_instance 
  inst, mzs_state* status, sb4* playRate)
{
  mkd_pos _result;
  ysevt* noreg _sem = (ysevt*)0;
  struct mzs_stream__tyimpl* _impl;
  ...
  if ( _impl )
  {
    if ( _widen )
    {
      yogfp _f = (*_widen)( (ub4)14, (dvoid *)_impl, mzs_stream__id);
      _result = (*(mkd_pos (*)( mzs_stream, yoenv*, mzs_stream_instance, 
        mzs_state*, sb4*))_f)(or, ev, inst, status, playRate);
    }
    else
...
void mzs_stream_getPos_nw( mzs_stream or, yoenv* ev, mzs_stream_instance 
  inst, mzs_state* status, sb4* playRate, ysevt* _sem)
{
  dvoid * _parvec[3];

  _parvec[0] = (dvoid *)&inst;
  _parvec[1] = (dvoid *) status;
  _parvec[2] = (dvoid *) playRate;
  yoSendReq( (dvoid *)or, ev, "getPos", TRUE, _sem, (sword)3, 
    mzs_stream_getPos_pars, _parvec);
}
...
void mzs_stream_dealloc( mzs_stream or, yoenv* ev)
{
  ...
  if ( _impl )
  {
    if ( _widen )
    {
      yogfp _f = (*_widen)( (ub4)15, (dvoid *)_impl, mzs_stream__id);
...
{
  yoSendReq( (dvoid *)or, ev, "dealloc", TRUE, _sem, (sword)0, 
    mzs_stream_dealloc_pars, (dvoid **)0);
}


static CONST_DATA yotk mzs_physAddr__tc[] = 
...
{
  yotkFreeVal( YCTC_mzs_physAddr, (dvoid *)val, ffunc);
}

void mzs_physAddr__copy( mzs_physAddr* dest, mzs_physAddr* src, ysmaf afunc)
  
{
  yotkCopyVal( YCTC_mzs_physAddr, (dvoid *)dest, (dvoid *)src, afunc);
}
...
static CONST_DATA yotk mzs_factory__tc[] = 
  {0x00,0x00,0x00,0x0e,0x00,0x00,0x00,'/',0x00,0x00,0x00,0x00,
...
{
  yotkFreeVal( YCTC_mzs_factory, (dvoid *)val, ffunc);
}

void mzs_factory__copy( mzs_factory* dest, mzs_factory* src, ysmaf afunc)
{
  yotkCopyVal( YCTC_mzs_factory, (dvoid *)dest, (dvoid *)src, afunc);
}

static CONST_DATA yotk mzs_factory_bootRespInfo__tc[] = 
  {0x00,0x00,0x00,0x0f,0x00,0x00,0x00,'l',0x00,0x00,0x00,0x00,
...
void mzs_factory_bootRespInfo__free( mzs_factory_bootRespInfo* val, ysmff 
  ffunc)
{
  yotkFreeVal( YCTC_mzs_factory_bootRespInfo, (dvoid *)val, ffunc);
}

void mzs_factory_bootRespInfo__copy( mzs_factory_bootRespInfo* dest, 
  mzs_factory_bootRespInfo* src, ysmaf afunc)
{
  yotkCopyVal( YCTC_mzs_factory_bootRespInfo, (dvoid *)dest, (dvoid *)src, 
    afunc);
}
...
mzs_stream mzs_factory_alloc( mzs_factory or, yoenv* ev, mzc_circuit* 
  clientCircuit, mzs_capMask capabilities, ub4 maxBitrate)
{
  mzs_stream _result;
  ysevt* noreg _sem = (ysevt*)0;
  ...
  NOREG(_sem);
  _impl = (struct mzs_factory__tyimpl*) yoLocalObj( (CORBA_Object)or, (
    yowiden*)&_widen);
  if ( _impl )
  {
    if ( _widen )
    {
      yogfp _f = (*_widen)( (ub4)0, (dvoid *)_impl, mzs_factory__id);
      _result = (*(mzs_stream (*)( mzs_factory, yoenv*, mzc_circuit*, 
        mzs_capMask, ub4))_f)(or, ev, clientCircuit, capabilities, 
        maxBitrate);
    }
    else
      _result = (*_impl->alloc)(or, ev, clientCircuit, capabilities, 
        maxBitrate);
  }
  else
  {
    ...
    {
      _sem = ysSemCreate((dvoid *)0);
      mzs_factory_alloc_nw( or, ev, clientCircuit, capabilities, maxBitrate,
         (ysevt*)_sem);
    }
    yseCatchAll
    {
...
void mzs_factory_alloc_nw( mzs_factory or, yoenv* ev, mzc_circuit* 
  clientCircuit, mzs_capMask capabilities, ub4 maxBitrate, ysevt* _sem)
{
  dvoid * _parvec[3];

  _parvec[0] = (dvoid *) clientCircuit;
  _parvec[1] = (dvoid *)&capabilities;
  _parvec[2] = (dvoid *)&maxBitrate;
  yoSendReq( (dvoid *)or, ev, "alloc", TRUE, _sem, (sword)3, 
    mzs_factory_alloc_pars, _parvec);
}
...
mzs_stream mzs_factory_boot( mzs_factory or, yoenv* ev, mzc_circuit* 
  clientCircuit, mkd_pos* startPos, mkd_pos* endPos, mzs_bootMask flags, 
  ub2 req_blocksz, mzs_factory_bootRespInfo* RespInfoP)
{
  mzs_stream _result;
  ysevt* noreg _sem = (ysevt*)0;
  struct mzs_factory__tyimpl* _impl;
  ...
  if ( _impl )
  {
    if ( _widen )
    {
      yogfp _f = (*_widen)( (ub4)1, (dvoid *)_impl, mzs_factory__id);
      _result = (*(mzs_stream (*)( mzs_factory, yoenv*, mzc_circuit*, 
        mkd_pos*, mkd_pos*, mzs_bootMask, ub2, mzs_factory_bootRespInfo*))
        _f)(or, ev, clientCircuit, startPos, endPos, flags, req_blocksz, 
        RespInfoP);
    }
    else
      _result = (*_impl->boot)(or, ev, clientCircuit, startPos, endPos, 
        flags, req_blocksz, RespInfoP);
  }
  else
  {
    yoFilterRunEx((dvoid *)or, ev, YOFLTR_CSND, (CONST  char*)0, (dvoid *)0)
    ...
    {
      _sem = ysSemCreate((dvoid *)0);
      mzs_factory_boot_nw( or, ev, clientCircuit, startPos, endPos, flags, 
        req_blocksz, RespInfoP, (ysevt*)_sem);
    }
    yseCatchAll
    {
      CONST ysid* _exid;
...
void mzs_factory_boot_nw( mzs_factory or, yoenv* ev, mzc_circuit* 
  clientCircuit, mkd_pos* startPos, mkd_pos* endPos, mzs_bootMask flags, 
  ub2 req_blocksz, mzs_factory_bootRespInfo* RespInfoP, ysevt* _sem)
{
  dvoid * _parvec[6];
  ...
  _parvec[1] = (dvoid *) startPos;
  _parvec[2] = (dvoid *) endPos;
  _parvec[3] = (dvoid *)&flags;
  _parvec[4] = (dvoid *)&req_blocksz;
  _parvec[5] = (dvoid *) RespInfoP;
  yoSendReq( (dvoid *)or, ev, "boot", TRUE, _sem, (sword)6, 
    mzs_factory_boot_pars, _parvec);
}
  ...
  
{
  ...
  if ( _impl )
  {
    if ( _widen )
    {
      yogfp _f = (*_widen)( (ub4)2, (dvoid *)_impl, mzs_factory__id);
...
void mzs_factory_getStats_nw( mzs_factory or, yoenv* ev, mzs_stats* 
  statistics, ysevt* _sem)
{
  dvoid * _parvec[1];

  _parvec[0] = (dvoid *) statistics;
  yoSendReq( (dvoid *)or, ev, "getStats", TRUE, _sem, (sword)1, 
    mzs_factory_getStats_pars, _parvec);
}
