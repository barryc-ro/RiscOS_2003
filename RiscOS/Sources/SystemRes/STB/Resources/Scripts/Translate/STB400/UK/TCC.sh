...
««Cmnt14»»
««Cmnt15»»
# '/stbboot/435tcc/' ««Cmnt16»»
««Cmnt17»»
««Cmnt18»»
««Cmnt19»»
#   ./TCC.sh /stbboot/Releases/435 /stbboot/435tcc
««Cmnt20»»
««Cmnt21»» ««Version»», ««Date»»

echo Create TCC V2 \(Korean\) Baseline...
...
replace.sh Territory/Config,feb '\|Set STB\$Territory USA'         'Set STB\$Territory Korea'
replace.sh Territory/Config,feb '\|Set STB\$Languages en-us'       'Set STB\$Languages ko,en,en-us'
replace.sh Territory/Config,feb '\|Set STB\$Encoding 2252'         'Set STB\$Encoding 38'
