...
extern void oimage_size_image(antweb_doc *doc, const char *alt, const rid_stdunits *req_ww, const rid_stdunits *req_hh, rid_image_flags flags, rid_flag text_flags, int scale_value, int fwidth, int *iw, int *ih);
