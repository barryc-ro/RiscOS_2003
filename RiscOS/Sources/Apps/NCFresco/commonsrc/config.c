...
{ config_BOOL,  "display.frames.top_level",    (void *)offsetof(struct config_str, display_frames_top_level),	"Display top level as frame", (void *)0  },
...
{ config_INT, "display.highlight.style",	(void *)offsetof(struct config_str, display_highlight_style), "Style for drawing highlight",	(void *) 0  },
{ config_INT, "display.highlight.width",	(void *)offsetof(struct config_str, display_highlight_width), "Width of highlight",		(void *) 1  },
{ config_COMMENT, NULL, NULL, "", NULL },
...
{ config_COMMENT, NULL, NULL, "", NULL },
{ config_FONT, "font.base",	(void *)offsetof(struct config_str, font_names[0]),	"Name of standard (body) font",	"Trinity.Medium"  },
...
{ config_FONT, "font.head",	(void *)offsetof(struct config_str, font_names[8]),	"Name of headings font",	"Homerton.Medium"  },
{ config_FONT, "font.head.b",	(void *)offsetof(struct config_str, font_names[9]),	"... the bold form",	"Homerton.Bold"  },
{ config_FONT, "font.head.i",	(void *)offsetof(struct config_str, font_names[10]),	"... the italic form",	"Homerton.Medium.Oblique"  },
{ config_FONT, "font.head.bi",	(void *)offsetof(struct config_str, font_names[11]),	"... bold and italic",	"Homerton.Bold.Oblique"  },
...
{ config_FONT, "font.symbol",	(void *)offsetof(struct config_str, font_names[12]),	"Name of symbol font",	"Selwyn"  },
{ config_FONT, "font.internal",	(void *)offsetof(struct config_str, font_names[13]),	"Name of internal menu font",	"Homerton.Medium"  },
{ config_FONT, "font.japanese",	(void *)offsetof(struct config_str, font_names[14]),	"Name of japanese font",	"HeiBold"  },
{ config_COMMENT, NULL, NULL, "", NULL },
...
{ config_INT, "mode.mouse.menu", 	(void *)offsetof(struct config_str, mode_mouse_menu),	"Menu click action", (void *)0  },
{ config_INT, "mode.errors", 	(void *)offsetof(struct config_str, mode_errors),	"Action on errors", (void *)0  },
...
{ config_INT, "hots.length", 	(void *)offsetof(struct config_str, hots_length),	"Max number in hotlist", (void *)50 },
