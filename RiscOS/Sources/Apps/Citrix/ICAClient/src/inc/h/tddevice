...
#define TDDEVICE__SETINFO	10
#define TDDEVICE__COUNT		11
...
typedef int FNTDDEVICESETINFO( PPD, PPDSETINFORMATION );
typedef FNTDDEVICESETINFO *PFNTDDEVICESETINFO;
...
#define DeviceSetInfo(a,b)	((PFNTDDEVICESETINFO)((a)->pDeviceProcedures[TDDEVICE__SETINFO]))(a,b)
