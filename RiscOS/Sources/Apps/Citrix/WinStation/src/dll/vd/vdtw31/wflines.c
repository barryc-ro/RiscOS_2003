...
*   WFLINES.C
*
*   Thin Wire Windows - Strip Generator Code
*
...
#ifdef CITRIX
    TWPOINTFIXI* pptfxBufEnd = pptfxBuf + cptfx; // Last point in path record
#else
            ...
            while(TRUE)
            {
                ...
                *plStrip++ = i;
                ...
                if (plStrip == plStripEnd)
                {
                    ...
                    tempStrip = &strip.alStrips[0];
                    strip.cStrips = plStrip - tempStrip;

                    (*pfn)(hDC, &strip, pls, NULL );
#else
