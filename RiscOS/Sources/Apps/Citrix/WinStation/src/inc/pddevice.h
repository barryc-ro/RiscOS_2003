...
#define PDDEVICE__CHECKWRITE	12
#define PDDEVICE__CANCELWRITE	13
#define PDDEVICE__SENDBREAK	14
#define PDDEVICE__CALLBACK	15
#define PDDEVICE__SETINFO	16
#define PDDEVICE__QUERYINFO	17
#define PDDEVICE__OUTBUFALLOC	18
#define PDDEVICE__OUTBUFERROR	19
#define PDDEVICE__OUTBUFFREE	20
#define PDDEVICE__COUNT		21
...
typedef int FNPDDEVICEWRITE( PPD, POUTBUF, PUSHORT );
...
typedef int FNPDDEVICECANCELWRITE( PPD, POUTBUF );
typedef FNPDDEVICECANCELWRITE *PFNPDDEVICECANCELWRITE;

typedef int FNPDDEVICESENDBREAK( PPD );
typedef FNPDDEVICESENDBREAK *PFNPDDEVICESENDBREAK;
...
#define DeviceWrite(a,b,c)	((PFNPDDEVICEWRITE)((a)->pDeviceProcedures[PDDEVICE__WRITE]))(a,b,c)
#define DeviceCheckWrite(a,b)	((PFNPDDEVICECHECKWRITE)((a)->pDeviceProcedures[PDDEVICE__CHECKWRITE]))(a,b)
#define DeviceCancelWrite(a,b)	((PFNPDDEVICECANCELWRITE)((a)->pDeviceProcedures[PDDEVICE__CANCELWRITE]))(a,b)

#define DeviceSendBreak(a)	((PFNPDDEVICESENDBREAK)((a)->pDeviceProcedures[PDDEVICE__SENDBREAK]))(a)
