...
*
*     Rev 1.207   16 Sep 1997 20:13:02   CTXSRC2
*  Modified for client split
*
...
#define VER_LEGALCOPYRIGHT_STR          "Copyright \251 1990-1998 Citrix Systems, Inc."
#define ENC_VER_DOS_LEGALCOPYRIGHT_STR  "Copyright (c) 1990-1998 Citrix Systems, Inc.\nCopyright (c) 1986-1997 RSA Data Security Inc."
