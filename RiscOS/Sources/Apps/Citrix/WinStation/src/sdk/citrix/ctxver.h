...
*  CTXVER.H
*
*  This module defines the CITRIX NT build version.
*
*  Copyright Citrix Systems Inc. 1994
*
*  Author: Mike Discavage
*
*  Changed 11/13/96 JR to leave MS build in place.
*  Changed 11/23/96 ButchD to implement less obtrusive Citrix re-versioning
*
****************************************************************************/
...
#define VER_CTXPRODUCTBUILD         277

#define VER_CTXPRODUCTBUILD_STR    "277"
...
#define VER_CTXPRODUCTVERSION_STR       "2.00"
#define VER_CTXPRODUCTVERSION           2,00,VER_CTXPRODUCTBUILD,1
