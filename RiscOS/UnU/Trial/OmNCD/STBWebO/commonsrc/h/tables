...
extern int  dummy_tidy_proc(rid_pos_item *new_item, int width, int display_width);
...
/* backend.c */
extern rid_pos_item *be_formater_loop_core(rid_text_stream *st, rid_text_item *ti, rid_fmt_info *fmt, int flags);
